	...
	integer *ldz, floatreal *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int dlanv2_(floatreal *, floatreal *, 
	    ...
	    floatreal *, floatreal *, floatreal *, floatreal *), dlaqr3_(
	    logical *, logical *, integer *, integer *, integer *, integer *, 
	    floatreal *, integer *, integer *, integer *, floatreal *, 
	    integer *, integer *, integer *, floatreal *, floatreal *, 
...
/*           block, WI(i) = sqrtf(-H(i+1,i)*H(i,i+1)) and */
/*           WI(i+1) = -WI(i). */
