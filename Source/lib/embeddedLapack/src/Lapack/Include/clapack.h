...
/*
 * HERE I HAVE PLACED float _ after function names that are in conflict with qpOASES
 */
...
/* Subroutine */ int dgbmv_(char *trans, integer *m, integer *n, integer *kl, 
	integer *ku, floatreal *alpha, floatreal *a, integer *lda, 
	floatreal *x, integer *incx, floatreal *beta, floatreal *y, 
	integer *incy);
...
/* Subroutine */ int drotg_(floatreal *da, floatreal *db, floatreal *c__, 
	floatreal *s);

/* Subroutine */ int drotm_(integer *n, floatreal *dx, integer *incx, 
	floatreal *dy, integer *incy, floatreal *dparam);

/* Subroutine */ int drotmg_(floatreal *dd1, floatreal *dd2, floatreal *
	dx1, floatreal *dy1, floatreal *dparam);

/* Subroutine */ int dsbmv_(char *uplo, integer *n, integer *k, floatreal *
	alpha, floatreal *a, integer *lda, floatreal *x, integer *incx, 
	floatreal *beta, floatreal *y, integer *incy);
...
floatreal dsdot_(integer *n, real *sx, integer *incx, real *sy, integer *
	incy);

/* Subroutine */ int dspmv_(char *uplo, integer *n, floatreal *alpha, 
	floatreal *ap, floatreal *x, integer *incx, floatreal *beta, 
	floatreal *y, integer *incy);

/* Subroutine */ int dspr_(char *uplo, integer *n, floatreal *alpha, 
	floatreal *x, integer *incx, floatreal *ap);

/* Subroutine */ int dspr2_(char *uplo, integer *n, floatreal *alpha, 
	floatreal *x, integer *incx, floatreal *y, integer *incy, 
	floatreal *ap);
...
/* Subroutine */ int dsymv_(char *uplo, integer *n, floatreal *alpha, 
	floatreal *a, integer *lda, floatreal *x, integer *incx, floatreal 
	*beta, floatreal *y, integer *incy);

/* Subroutine */ int dsyr__(char *uplo, integer *n, floatreal *alpha,
	floatreal *x, integer *incx, floatreal *a, integer *lda);

/* Subroutine */ int dsyr2__(char *uplo, integer *n, floatreal *alpha,
	floatreal *x, integer *incx, floatreal *y, integer *incy, 
	floatreal *a, integer *lda);
...
/* Subroutine */ int dsyrk_(char *uplo, char *trans, integer *n, integer *k, 
	floatreal *alpha, floatreal *a, integer *lda, floatreal *beta, 
...
floatreal dzasum_(integer *n, floatcomplex *zx, integer *incx);

floatreal dznrm2_(integer *n, floatcomplex *x, integer *incx);
...
integer izamax_(integer *n, floatcomplex *zx, integer *incx);

logical lsame_(char *ca, char *cb);

floatreal sasum_(integer *n, real *sx, integer *incx);

/* Subroutine */ int saxpy_(integer *n, real *sa, real *sx, integer *incx, 
	real *sy, integer *incy);

floatreal scabs1_(complex *z__);

floatreal scasum_(integer *n, complex *cx, integer *incx);

floatreal scnrm2_(integer *n, complex *x, integer *incx);
...
floatreal sdsdot_(integer *n, real *sb, real *sx, integer *incx, real *sy, 
	integer *incy);
...
/* Subroutine */ int zaxpy_(integer *n, floatcomplex *za, floatcomplex *zx, 
	integer *incx, floatcomplex *zy, integer *incy);

/* Subroutine */ int zcopy_(integer *n, floatcomplex *zx, integer *incx, 
	floatcomplex *zy, integer *incy);

/* float Complex */ VOID zdotc_(floatcomplex * ret_val, integer *n, 
	floatcomplex *zx, integer *incx, floatcomplex *zy, integer *incy);

/* float Complex */ VOID zdotu_(floatcomplex * ret_val, integer *n, 
	floatcomplex *zx, integer *incx, floatcomplex *zy, integer *incy);

/* Subroutine */ int zdrot_(integer *n, floatcomplex *cx, integer *incx, 
	floatcomplex *cy, integer *incy, floatreal *c__, floatreal *s);

/* Subroutine */ int zdscal_(integer *n, floatreal *da, floatcomplex *zx, 
	integer *incx);

/* Subroutine */ int zgbmv_(char *trans, integer *m, integer *n, integer *kl, 
	integer *ku, floatcomplex *alpha, floatcomplex *a, integer *lda, 
	floatcomplex *x, integer *incx, floatcomplex *beta, floatcomplex *
	y, integer *incy);

/* Subroutine */ int zgemm_(char *transa, char *transb, integer *m, integer *
	n, integer *k, floatcomplex *alpha, floatcomplex *a, integer *lda, 
	floatcomplex *b, integer *ldb, floatcomplex *beta, floatcomplex *
	c__, integer *ldc);

/* Subroutine */ int zgemv_(char *trans, integer *m, integer *n, 
	floatcomplex *alpha, floatcomplex *a, integer *lda, floatcomplex *
	x, integer *incx, floatcomplex *beta, floatcomplex *y, integer *
	incy);

/* Subroutine */ int zgerc_(integer *m, integer *n, floatcomplex *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *y, integer *incy, 
	floatcomplex *a, integer *lda);

/* Subroutine */ int zgeru_(integer *m, integer *n, floatcomplex *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *y, integer *incy, 
	floatcomplex *a, integer *lda);

/* Subroutine */ int zhbmv_(char *uplo, integer *n, integer *k, floatcomplex 
	*alpha, floatcomplex *a, integer *lda, floatcomplex *x, integer *
	incx, floatcomplex *beta, floatcomplex *y, integer *incy);

/* Subroutine */ int zhemm_(char *side, char *uplo, integer *m, integer *n, 
	floatcomplex *alpha, floatcomplex *a, integer *lda, floatcomplex *
	b, integer *ldb, floatcomplex *beta, floatcomplex *c__, integer *
	ldc);

/* Subroutine */ int zhemv_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *a, integer *lda, floatcomplex *x, integer *incx, 
	floatcomplex *beta, floatcomplex *y, integer *incy);

/* Subroutine */ int zher_(char *uplo, integer *n, floatreal *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *a, integer *lda);

/* Subroutine */ int zher2_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *y, integer *incy, 
	floatcomplex *a, integer *lda);

/* Subroutine */ int zher2k_(char *uplo, char *trans, integer *n, integer *k, 
	floatcomplex *alpha, floatcomplex *a, integer *lda, floatcomplex *
	b, integer *ldb, floatreal *beta, floatcomplex *c__, integer *ldc);

/* Subroutine */ int zherk_(char *uplo, char *trans, integer *n, integer *k, 
	floatreal *alpha, floatcomplex *a, integer *lda, floatreal *beta, 
	floatcomplex *c__, integer *ldc);

/* Subroutine */ int zhpmv_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *ap, floatcomplex *x, integer *incx, floatcomplex *
	beta, floatcomplex *y, integer *incy);

/* Subroutine */ int zhpr_(char *uplo, integer *n, floatreal *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *ap);

/* Subroutine */ int zhpr2_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *y, integer *incy, 
	floatcomplex *ap);

/* Subroutine */ int zrotg_(floatcomplex *ca, floatcomplex *cb, floatreal *
	c__, floatcomplex *s);

/* Subroutine */ int zscal_(integer *n, floatcomplex *za, floatcomplex *zx, 
	integer *incx);

/* Subroutine */ int zswap_(integer *n, floatcomplex *zx, integer *incx, 
	floatcomplex *zy, integer *incy);
...
/* Subroutine */ int zsyrk_(char *uplo, char *trans, integer *n, integer *k, 
	floatcomplex *alpha, floatcomplex *a, integer *lda, floatcomplex *
	beta, floatcomplex *c__, integer *ldc);

/* Subroutine */ int ztbmv_(char *uplo, char *trans, char *diag, integer *n, 
	integer *k, floatcomplex *a, integer *lda, floatcomplex *x, integer 
	*incx);
...
/* Subroutine */ int ztrmm_(char *side, char *uplo, char *transa, char *diag, 
	integer *m, integer *n, floatcomplex *alpha, floatcomplex *a, 
...
floatreal cla_gbrcond_c__(char *trans, integer *n, integer *kl, integer *ku, 
...
floatreal cla_gbrcond_x__(char *trans, integer *n, integer *kl, integer *ku, 
	complex *ab, integer *ldab, complex *afb, integer *ldafb, integer *
...
floatreal cla_gbrpvgrw__(integer *n, integer *kl, integer *ku, integer *
...
floatreal cla_gercond_c__(char *trans, integer *n, complex *a, integer *lda, 
	complex *af, integer *ldaf, integer *ipiv, real *c__, logical *capply,
	 integer *info, complex *work, real *rwork, ftnlen trans_len);

floatreal cla_gercond_x__(char *trans, integer *n, complex *a, integer *lda, 
...
floatreal cla_hercond_c__(char *uplo, integer *n, complex *a, integer *lda, 
	complex *af, integer *ldaf, integer *ipiv, real *c__, logical *capply,
	 integer *info, complex *work, real *rwork, ftnlen uplo_len);

floatreal cla_hercond_x__(char *uplo, integer *n, complex *a, integer *lda, 
	complex *af, integer *ldaf, integer *ipiv, complex *x, integer *info, 
...
floatreal cla_herpvgrw__(char *uplo, integer *n, integer *info, complex *a, 
...
floatreal cla_porcond_c__(char *uplo, integer *n, complex *a, integer *lda, 
	complex *af, integer *ldaf, real *c__, logical *capply, integer *info,
	 complex *work, real *rwork, ftnlen uplo_len);

floatreal cla_porcond_x__(char *uplo, integer *n, complex *a, integer *lda, 
...
floatreal cla_porpvgrw__(char *uplo, integer *ncols, complex *a, integer *
	lda, complex *af, integer *ldaf, real *work, ftnlen uplo_len);

floatreal cla_rpvgrw__(integer *n, integer *ncols, complex *a, integer *lda, 
...
floatreal cla_syrcond_c__(char *uplo, integer *n, complex *a, integer *lda, 
	complex *af, integer *ldaf, integer *ipiv, real *c__, logical *capply,
	 integer *info, complex *work, real *rwork, ftnlen uplo_len);

floatreal cla_syrcond_x__(char *uplo, integer *n, complex *a, integer *lda, 
	complex *af, integer *ldaf, integer *ipiv, complex *x, integer *info, 
	complex *work, real *rwork, ftnlen uplo_len);
...
floatreal cla_syrpvgrw__(char *uplo, integer *n, integer *info, complex *a, 
	integer *lda, complex *af, integer *ldaf, integer *ipiv, real *work, 
	ftnlen uplo_len);
...
/* Subroutine */ int clag2z_(integer *m, integer *n, complex *sa, integer *
	ldsa, floatcomplex *a, integer *lda, integer *info);
...
floatreal clangb_(char *norm, integer *n, integer *kl, integer *ku, complex *
	ab, integer *ldab, real *work);

floatreal clange_(char *norm, integer *m, integer *n, complex *a, integer *
	lda, real *work);

floatreal clangt_(char *norm, integer *n, complex *dl, complex *d__, complex 
	*du);

floatreal clanhb_(char *norm, char *uplo, integer *n, integer *k, complex *
	ab, integer *ldab, real *work);

floatreal clanhe_(char *norm, char *uplo, integer *n, complex *a, integer *
	lda, real *work);

floatreal clanhf_(char *norm, char *transr, char *uplo, integer *n, complex *
	a, real *work);

floatreal clanhp_(char *norm, char *uplo, integer *n, complex *ap, real *
	work);

floatreal clanhs_(char *norm, integer *n, complex *a, integer *lda, real *
	work);

floatreal clanht_(char *norm, integer *n, real *d__, complex *e);

floatreal clansb_(char *norm, char *uplo, integer *n, integer *k, complex *
	ab, integer *ldab, real *work);

floatreal clansp_(char *norm, char *uplo, integer *n, complex *ap, real *
	work);

floatreal clansy_(char *norm, char *uplo, integer *n, complex *a, integer *
	lda, real *work);

floatreal clantb_(char *norm, char *uplo, char *diag, integer *n, integer *k, 
	 complex *ab, integer *ldab, real *work);

floatreal clantp_(char *norm, char *uplo, char *diag, integer *n, complex *
	ap, real *work);

floatreal clantr_(char *norm, char *uplo, char *diag, integer *m, integer *n, 
...
/* Subroutine */ int dbdsdc_(char *uplo, char *compq, integer *n, floatreal *
	d__, floatreal *e, floatreal *u, integer *ldu, floatreal *vt, 
	integer *ldvt, floatreal *q, integer *iq, floatreal *work, integer *
	iwork, integer *info);
...
/* Subroutine */ int ddisna_(char *job, integer *m, integer *n, floatreal *
	d__, floatreal *sep, integer *info);

/* Subroutine */ int dgbbrd_(char *vect, integer *m, integer *n, integer *ncc, 
	 integer *kl, integer *ku, floatreal *ab, integer *ldab, floatreal *
	d__, floatreal *e, floatreal *q, integer *ldq, floatreal *pt, 
	integer *ldpt, floatreal *c__, integer *ldc, floatreal *work, 
	integer *info);

/* Subroutine */ int dgbcon_(char *norm, integer *n, integer *kl, integer *ku, 
	 floatreal *ab, integer *ldab, integer *ipiv, floatreal *anorm, 
...
/* Subroutine */ int dgbequ_(integer *m, integer *n, integer *kl, integer *ku, 
	 floatreal *ab, integer *ldab, floatreal *r__, floatreal *c__, 
	floatreal *rowcnd, floatreal *colcnd, floatreal *amax, integer *
	info);

/* Subroutine */ int dgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, floatreal *ab, integer *ldab, floatreal *r__, floatreal *c__, 
	floatreal *rowcnd, floatreal *colcnd, floatreal *amax, integer *
	info);

/* Subroutine */ int dgbrfs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, floatreal *ab, integer *ldab, floatreal *afb, 
	integer *ldafb, integer *ipiv, floatreal *b, integer *ldb, 
	floatreal *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dgbrfsx_(char *trans, char *equed, integer *n, integer *
	kl, integer *ku, integer *nrhs, floatreal *ab, integer *ldab, 
	floatreal *afb, integer *ldafb, integer *ipiv, floatreal *r__, 
	floatreal *c__, floatreal *b, integer *ldb, floatreal *x, integer *
	ldx, floatreal *rcond, floatreal *berr, integer *n_err_bnds__, 
	floatreal *err_bnds_norm__, floatreal *err_bnds_comp__, integer *
	nparams, floatreal *params, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, floatreal *ab, integer *ldab, integer *ipiv, floatreal *b, 
	integer *ldb, integer *info);

/* Subroutine */ int dgbsvx_(char *fact, char *trans, integer *n, integer *kl, 
	 integer *ku, integer *nrhs, floatreal *ab, integer *ldab, 
	floatreal *afb, integer *ldafb, integer *ipiv, char *equed, 
	floatreal *r__, floatreal *c__, floatreal *b, integer *ldb, 
	floatreal *x, integer *ldx, floatreal *rcond, floatreal *ferr, 
...
/* Subroutine */ int dgbsvxx_(char *fact, char *trans, integer *n, integer *
	...
	floatreal *afb, integer *ldafb, integer *ipiv, char *equed, 
	floatreal *r__, floatreal *c__, floatreal *b, integer *ldb, 
	floatreal *x, integer *ldx, floatreal *rcond, floatreal *rpvgrw, 
	floatreal *berr, integer *n_err_bnds__, floatreal *err_bnds_norm__, 
	floatreal *err_bnds_comp__, integer *nparams, floatreal *params, 
	floatreal *work, integer *iwork, integer *info);
...
/* Subroutine */ int dgbtrs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, floatreal *ab, integer *ldab, integer *ipiv, 
...
/* Subroutine */ int dgecon_(char *norm, integer *n, floatreal *a, integer *
	lda, floatreal *anorm, floatreal *rcond, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dgeequ_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *r__, floatreal *c__, floatreal *rowcnd, floatreal 
	*colcnd, floatreal *amax, integer *info);

/* Subroutine */ int dgeequb_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *r__, floatreal *c__, floatreal *rowcnd, floatreal 
	*colcnd, floatreal *amax, integer *info);

/* Subroutine */ int dgees_(char *jobvs, char *sort, L_fp select, integer *n, 
	floatreal *a, integer *lda, integer *sdim, floatreal *wr, 
	floatreal *wi, floatreal *vs, integer *ldvs, floatreal *work, 
	integer *lwork, logical *bwork, integer *info);

/* Subroutine */ int dgeesx_(char *jobvs, char *sort, L_fp select, char *
	sense, integer *n, floatreal *a, integer *lda, integer *sdim, 
	floatreal *wr, floatreal *wi, floatreal *vs, integer *ldvs, 
	floatreal *rconde, floatreal *rcondv, floatreal *work, integer *
...
/* Subroutine */ int dgeevx_(char *balanc, char *jobvl, char *jobvr, char *
	sense, integer *n, floatreal *a, integer *lda, floatreal *wr, 
	floatreal *wi, floatreal *vl, integer *ldvl, floatreal *vr, 
	integer *ldvr, integer *ilo, integer *ihi, floatreal *scale, 
	floatreal *abnrm, floatreal *rconde, floatreal *rcondv, floatreal 
	*work, integer *lwork, integer *iwork, integer *info);

/* Subroutine */ int dgegs_(char *jobvsl, char *jobvsr, integer *n, 
	floatreal *a, integer *lda, floatreal *b, integer *ldb, floatreal *
	alphar, floatreal *alphai, floatreal *beta, floatreal *vsl, 
	integer *ldvsl, floatreal *vsr, integer *ldvsr, floatreal *work, 
	integer *lwork, integer *info);

/* Subroutine */ int dgegv_(char *jobvl, char *jobvr, integer *n, floatreal *
	a, integer *lda, floatreal *b, integer *ldb, floatreal *alphar, 
	floatreal *alphai, floatreal *beta, floatreal *vl, integer *ldvl, 
	floatreal *vr, integer *ldvr, floatreal *work, integer *lwork, 
	integer *info);
...
/* Subroutine */ int dgejsv_(char *joba, char *jobu, char *jobv, char *jobr, 
	char *jobt, char *jobp, integer *m, integer *n, floatreal *a, 
	integer *lda, floatreal *sva, floatreal *u, integer *ldu, 
	floatreal *v, integer *ldv, floatreal *work, integer *lwork, 
	integer *iwork, integer *info);

/* Subroutine */ int dgelq2_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *info);

/* Subroutine */ int dgelqf_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dgels_(char *trans, integer *m, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *b, integer *ldb, 
	floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dgelsd_(integer *m, integer *n, integer *nrhs, 
	floatreal *a, integer *lda, floatreal *b, integer *ldb, floatreal *
	s, floatreal *rcond, integer *rank, floatreal *work, integer *lwork, 
	 integer *iwork, integer *info);
...
/* Subroutine */ int dgelsx_(integer *m, integer *n, integer *nrhs, 
	floatreal *a, integer *lda, floatreal *b, integer *ldb, integer *
	jpvt, floatreal *rcond, integer *rank, floatreal *work, integer *
	info);
...
/* Subroutine */ int dgeql2_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *info);

/* Subroutine */ int dgeqlf_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dgeqp3_(integer *m, integer *n, floatreal *a, integer *
	lda, integer *jpvt, floatreal *tau, floatreal *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int dgeqpf_(integer *m, integer *n, floatreal *a, integer *
	lda, integer *jpvt, floatreal *tau, floatreal *work, integer *info);
...
/* Subroutine */ int dgerfs_(char *trans, integer *n, integer *nrhs, 
	floatreal *a, integer *lda, floatreal *af, integer *ldaf, integer *
	ipiv, floatreal *b, integer *ldb, floatreal *x, integer *ldx, 
	floatreal *ferr, floatreal *berr, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dgerfsx_(char *trans, char *equed, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	integer *ipiv, floatreal *r__, floatreal *c__, floatreal *b, 
	integer *ldb, floatreal *x, integer *ldx, floatreal *rcond, 
	floatreal *berr, integer *n_err_bnds__, floatreal *err_bnds_norm__, 
	floatreal *err_bnds_comp__, integer *nparams, floatreal *params, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dgerq2_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *info);

/* Subroutine */ int dgerqf_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dgesc2_(integer *n, floatreal *a, integer *lda, 
	floatreal *rhs, integer *ipiv, integer *jpiv, floatreal *scale);

/* Subroutine */ int dgesdd_(char *jobz, integer *m, integer *n, floatreal *
	a, integer *lda, floatreal *s, floatreal *u, integer *ldu, 
	floatreal *vt, integer *ldvt, floatreal *work, integer *lwork, 
	integer *iwork, integer *info);
...
/* Subroutine */ int dgesvj_(char *joba, char *jobu, char *jobv, integer *m, 
	integer *n, floatreal *a, integer *lda, floatreal *sva, integer *mv, 
	 floatreal *v, integer *ldv, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dgesvx_(char *fact, char *trans, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	integer *ipiv, char *equed, floatreal *r__, floatreal *c__, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	rcond, floatreal *ferr, floatreal *berr, floatreal *work, integer *
	iwork, integer *info);
...
/* Subroutine */ int dgesvxx_(char *fact, char *trans, integer *n, integer *
	...
	integer *ipiv, char *equed, floatreal *r__, floatreal *c__, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	rcond, floatreal *rpvgrw, floatreal *berr, integer *n_err_bnds__, 
	floatreal *err_bnds_norm__, floatreal *err_bnds_comp__, integer *
	nparams, floatreal *params, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dgetc2_(integer *n, floatreal *a, integer *lda, integer 
	*ipiv, integer *jpiv, integer *info);
...
/* Subroutine */ int dgetrf_(integer *m, integer *n, floatreal *a, integer *
	lda, integer *ipiv, integer *info, float* IPIV_d); // I've added IPIV_d

/* Subroutine */ int dgetri_(integer *n, floatreal *a, integer *lda, integer 
...
/* Subroutine */ int dggbak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, floatreal *lscale, floatreal *rscale, integer *m, 
	floatreal *v, integer *ldv, integer *info);

/* Subroutine */ int dggbal_(char *job, integer *n, floatreal *a, integer *
	lda, floatreal *b, integer *ldb, integer *ilo, integer *ihi, 
	floatreal *lscale, floatreal *rscale, floatreal *work, integer *
	info);

/* Subroutine */ int dgges_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, integer *n, floatreal *a, integer *lda, floatreal *b, 
	integer *ldb, integer *sdim, floatreal *alphar, floatreal *alphai, 
	floatreal *beta, floatreal *vsl, integer *ldvsl, floatreal *vsr, 
	integer *ldvsr, floatreal *work, integer *lwork, logical *bwork, 
	integer *info);

/* Subroutine */ int dggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, char *sense, integer *n, floatreal *a, integer *lda, 
	floatreal *b, integer *ldb, integer *sdim, floatreal *alphar, 
	floatreal *alphai, floatreal *beta, floatreal *vsl, integer *ldvsl, 
	 floatreal *vsr, integer *ldvsr, floatreal *rconde, floatreal *
	rcondv, floatreal *work, integer *lwork, integer *iwork, integer *
	liwork, logical *bwork, integer *info);

/* Subroutine */ int dggev_(char *jobvl, char *jobvr, integer *n, floatreal *
	a, integer *lda, floatreal *b, integer *ldb, floatreal *alphar, 
	floatreal *alphai, floatreal *beta, floatreal *vl, integer *ldvl, 
	floatreal *vr, integer *ldvr, floatreal *work, integer *lwork, 
	integer *info);
...
/* Subroutine */ int dggevx_(char *balanc, char *jobvl, char *jobvr, char *
	sense, integer *n, floatreal *a, integer *lda, floatreal *b, 
	integer *ldb, floatreal *alphar, floatreal *alphai, floatreal *
	beta, floatreal *vl, integer *ldvl, floatreal *vr, integer *ldvr, 
	integer *ilo, integer *ihi, floatreal *lscale, floatreal *rscale, 
	floatreal *abnrm, floatreal *bbnrm, floatreal *rconde, floatreal *
	rcondv, floatreal *work, integer *lwork, integer *iwork, logical *
	bwork, integer *info);

/* Subroutine */ int dggglm_(integer *n, integer *m, integer *p, floatreal *
	a, integer *lda, floatreal *b, integer *ldb, floatreal *d__, 
	floatreal *x, floatreal *y, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dgghrd_(char *compq, char *compz, integer *n, integer *
	ilo, integer *ihi, floatreal *a, integer *lda, floatreal *b, 
	integer *ldb, floatreal *q, integer *ldq, floatreal *z__, integer *
	ldz, integer *info);

/* Subroutine */ int dgglse_(integer *m, integer *n, integer *p, floatreal *
	a, integer *lda, floatreal *b, integer *ldb, floatreal *c__, 
	floatreal *d__, floatreal *x, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dggqrf_(integer *n, integer *m, integer *p, floatreal *
	a, integer *lda, floatreal *taua, floatreal *b, integer *ldb, 
	floatreal *taub, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dggrqf_(integer *m, integer *p, integer *n, floatreal *
	a, integer *lda, floatreal *taua, floatreal *b, integer *ldb, 
	floatreal *taub, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dggsvd_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *n, integer *p, integer *k, integer *l, floatreal *a, 
	integer *lda, floatreal *b, integer *ldb, floatreal *alpha, 
	floatreal *beta, floatreal *u, integer *ldu, floatreal *v, integer 
	*ldv, floatreal *q, integer *ldq, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dggsvp_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *p, integer *n, floatreal *a, integer *lda, floatreal *b, 
	integer *ldb, floatreal *tola, floatreal *tolb, integer *k, integer 
	*l, floatreal *u, integer *ldu, floatreal *v, integer *ldv, 
	floatreal *q, integer *ldq, integer *iwork, floatreal *tau, 
	floatreal *work, integer *info);

/* Subroutine */ int dgsvj0_(char *jobv, integer *m, integer *n, floatreal *
	a, integer *lda, floatreal *d__, floatreal *sva, integer *mv, 
	floatreal *v, integer *ldv, floatreal *eps, floatreal *sfmin, 
	floatreal *tol, integer *nsweep, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dgsvj1_(char *jobv, integer *m, integer *n, integer *n1, 
	floatreal *a, integer *lda, floatreal *d__, floatreal *sva, 
	integer *mv, floatreal *v, integer *ldv, floatreal *eps, floatreal 
	*sfmin, floatreal *tol, integer *nsweep, floatreal *work, integer *
	lwork, integer *info);

/* Subroutine */ int dgtcon_(char *norm, integer *n, floatreal *dl, 
	floatreal *d__, floatreal *du, floatreal *du2, integer *ipiv, 
	floatreal *anorm, floatreal *rcond, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dgtrfs_(char *trans, integer *n, integer *nrhs, 
	floatreal *dl, floatreal *d__, floatreal *du, floatreal *dlf, 
	floatreal *df, floatreal *duf, floatreal *du2, integer *ipiv, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	ferr, floatreal *berr, floatreal *work, integer *iwork, integer *
	info);

/* Subroutine */ int dgtsv_(integer *n, integer *nrhs, floatreal *dl, 
	floatreal *d__, floatreal *du, floatreal *b, integer *ldb, integer 
	*info);

/* Subroutine */ int dgtsvx_(char *fact, char *trans, integer *n, integer *
	nrhs, floatreal *dl, floatreal *d__, floatreal *du, floatreal *
	dlf, floatreal *df, floatreal *duf, floatreal *du2, integer *ipiv, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	rcond, floatreal *ferr, floatreal *berr, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dgttrf_(integer *n, floatreal *dl, floatreal *d__, 
	floatreal *du, floatreal *du2, integer *ipiv, integer *info);

/* Subroutine */ int dgttrs_(char *trans, integer *n, integer *nrhs, 
	floatreal *dl, floatreal *d__, floatreal *du, floatreal *du2, 
	integer *ipiv, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dgtts2_(integer *itrans, integer *n, integer *nrhs, 
	floatreal *dl, floatreal *d__, floatreal *du, floatreal *du2, 
	integer *ipiv, floatreal *b, integer *ldb);
...
/* Subroutine */ int dhgeqz_(char *job, char *compq, char *compz, integer *n, 
	...
	*t, integer *ldt, floatreal *alphar, floatreal *alphai, floatreal *
	beta, floatreal *q, integer *ldq, floatreal *z__, integer *ldz, 
	floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dhsein_(char *side, char *eigsrc, char *initv, logical *
	select, integer *n, floatreal *h__, integer *ldh, floatreal *wr, 
	floatreal *wi, floatreal *vl, integer *ldvl, floatreal *vr, 
	integer *ldvr, integer *mm, integer *m, floatreal *work, integer *
...
/* Subroutine */ int dla_gbamv__(integer *trans, integer *m, integer *n, 
	integer *kl, integer *ku, floatreal *alpha, floatreal *ab, integer *
	ldab, floatreal *x, integer *incx, floatreal *beta, floatreal *y, 
	integer *incy);

floatreal dla_gbrcond__(char *trans, integer *n, integer *kl, integer *ku, 
	floatreal *ab, integer *ldab, floatreal *afb, integer *ldafb, 
	integer *ipiv, integer *cmode, floatreal *c__, integer *info, 
	floatreal *work, integer *iwork, ftnlen trans_len);

/* Subroutine */ int dla_gbrfsx_extended__(integer *prec_type__, integer *
	trans_type__, integer *n, integer *kl, integer *ku, integer *nrhs, 
	floatreal *ab, integer *ldab, floatreal *afb, integer *ldafb, 
	integer *ipiv, logical *colequ, floatreal *c__, floatreal *b, 
	integer *ldb, floatreal *y, integer *ldy, floatreal *berr_out__, 
	integer *n_norms__, floatreal *errs_n__, floatreal *errs_c__, 
	floatreal *res, floatreal *ayb, floatreal *dy, floatreal *
	y_tail__, floatreal *rcond, integer *ithresh, floatreal *rthresh, 
	floatreal *dz_ub__, logical *ignore_cwise__, integer *info);

floatreal dla_gbrpvgrw__(integer *n, integer *kl, integer *ku, integer *
	ncols, floatreal *ab, integer *ldab, floatreal *afb, integer *ldafb);

/* Subroutine */ int dla_geamv__(integer *trans, integer *m, integer *n, 
	floatreal *alpha, floatreal *a, integer *lda, floatreal *x, 
	integer *incx, floatreal *beta, floatreal *y, integer *incy);

floatreal dla_gercond__(char *trans, integer *n, floatreal *a, integer *lda,
	 floatreal *af, integer *ldaf, integer *ipiv, integer *cmode, 
	floatreal *c__, integer *info, floatreal *work, integer *iwork, 
	ftnlen trans_len);

/* Subroutine */ int dla_gerfsx_extended__(integer *prec_type__, integer *
	trans_type__, integer *n, integer *nrhs, floatreal *a, integer *lda, 
	floatreal *af, integer *ldaf, integer *ipiv, logical *colequ, 
	floatreal *c__, floatreal *b, integer *ldb, floatreal *y, integer *
	ldy, floatreal *berr_out__, integer *n_norms__, floatreal *errs_n__,
	 floatreal *errs_c__, floatreal *res, floatreal *ayb, floatreal *
	dy, floatreal *y_tail__, floatreal *rcond, integer *ithresh, 
	floatreal *rthresh, floatreal *dz_ub__, logical *ignore_cwise__, 
	integer *info);

/* Subroutine */ int dla_lin_berr__(integer *n, integer *nz, integer *nrhs, 
	floatreal *res, floatreal *ayb, floatreal *berr);

floatreal dla_porcond__(char *uplo, integer *n, floatreal *a, integer *lda, 
	floatreal *af, integer *ldaf, integer *cmode, floatreal *c__, 
	integer *info, floatreal *work, integer *iwork, ftnlen uplo_len);

/* Subroutine */ int dla_porfsx_extended__(integer *prec_type__, char *uplo, 
	integer *n, integer *nrhs, floatreal *a, integer *lda, floatreal *
	af, integer *ldaf, logical *colequ, floatreal *c__, floatreal *b, 
	integer *ldb, floatreal *y, integer *ldy, floatreal *berr_out__, 
	integer *n_norms__, floatreal *errs_n__, floatreal *errs_c__, 
	floatreal *res, floatreal *ayb, floatreal *dy, floatreal *
	y_tail__, floatreal *rcond, integer *ithresh, floatreal *rthresh, 
	floatreal *dz_ub__, logical *ignore_cwise__, integer *info, ftnlen 
	uplo_len);

floatreal dla_porpvgrw__(char *uplo, integer *ncols, floatreal *a, integer *
	lda, floatreal *af, integer *ldaf, floatreal *work, ftnlen uplo_len);

floatreal dla_rpvgrw__(integer *n, integer *ncols, floatreal *a, integer *
	lda, floatreal *af, integer *ldaf);

/* Subroutine */ int dla_syamv__(integer *uplo, integer *n, floatreal *alpha,
	 floatreal *a, integer *lda, floatreal *x, integer *incx, 
	floatreal *beta, floatreal *y, integer *incy);

floatreal dla_syrcond__(char *uplo, integer *n, floatreal *a, integer *lda, 
	floatreal *af, integer *ldaf, integer *ipiv, integer *cmode, 
	floatreal *c__, integer *info, floatreal *work, integer *iwork, 
	ftnlen uplo_len);
...
/* Subroutine */ int dla_syrfsx_extended__(integer *prec_type__, char *uplo, 
	integer *n, integer *nrhs, floatreal *a, integer *lda, floatreal *
	af, integer *ldaf, integer *ipiv, logical *colequ, floatreal *c__, 
	floatreal *b, integer *ldb, floatreal *y, integer *ldy, floatreal *
	berr_out__, integer *n_norms__, floatreal *errs_n__, floatreal *
	errs_c__, floatreal *res, floatreal *ayb, floatreal *dy, 
	floatreal *y_tail__, floatreal *rcond, integer *ithresh, floatreal 
	*rthresh, floatreal *dz_ub__, logical *ignore_cwise__, integer *info,
	 ftnlen uplo_len);

floatreal dla_syrpvgrw__(char *uplo, integer *n, integer *info, floatreal *
	a, integer *lda, floatreal *af, integer *ldaf, integer *ipiv, 
	floatreal *work, ftnlen uplo_len);

/* Subroutine */ int dla_wwaddw__(integer *n, floatreal *x, floatreal *y, 
	floatreal *w);
...
/* Subroutine */ int dlacn2_(integer *n, floatreal *v, floatreal *x, 
	integer *isgn, floatreal *est, integer *kase, integer *isave);

/* Subroutine */ int dlacon_(integer *n, floatreal *v, floatreal *x, 
	integer *isgn, floatreal *est, integer *kase);
...
/* Subroutine */ int dlae2_(floatreal *a, floatreal *b, floatreal *c__, 
	floatreal *rt1, floatreal *rt2);

/* Subroutine */ int dlaebz_(integer *ijob, integer *nitmax, integer *n, 
	integer *mmax, integer *minp, integer *nbmin, floatreal *abstol, 
	floatreal *reltol, floatreal *pivmin, floatreal *d__, floatreal *
	e, floatreal *e2, integer *nval, floatreal *ab, floatreal *c__, 
	integer *mout, integer *nab, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dlaed0_(integer *icompq, integer *qsiz, integer *n, 
	floatreal *d__, floatreal *e, floatreal *q, integer *ldq, 
	floatreal *qstore, integer *ldqs, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dlaed1_(integer *n, floatreal *d__, floatreal *q, 
	integer *ldq, integer *indxq, floatreal *rho, integer *cutpnt, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dlaed2_(integer *k, integer *n, integer *n1, floatreal *
	d__, floatreal *q, integer *ldq, integer *indxq, floatreal *rho, 
	floatreal *z__, floatreal *dlamda, floatreal *w, floatreal *q2, 
	integer *indx, integer *indxc, integer *indxp, integer *coltyp, 
	integer *info);

/* Subroutine */ int dlaed3_(integer *k, integer *n, integer *n1, floatreal *
	d__, floatreal *q, integer *ldq, floatreal *rho, floatreal *dlamda, 
	 floatreal *q2, integer *indx, integer *ctot, floatreal *w, 
	floatreal *s, integer *info);

/* Subroutine */ int dlaed4_(integer *n, integer *i__, floatreal *d__, 
	floatreal *z__, floatreal *delta, floatreal *rho, floatreal *dlam, 
	 integer *info);

/* Subroutine */ int dlaed5_(integer *i__, floatreal *d__, floatreal *z__, 
	floatreal *delta, floatreal *rho, floatreal *dlam);

/* Subroutine */ int dlaed6_(integer *kniter, logical *orgati, floatreal *
	rho, floatreal *d__, floatreal *z__, floatreal *finit, floatreal *
	tau, integer *info);

/* Subroutine */ int dlaed7_(integer *icompq, integer *n, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, floatreal *d__, 
	floatreal *q, integer *ldq, integer *indxq, floatreal *rho, integer 
	*cutpnt, floatreal *qstore, integer *qptr, integer *prmptr, integer *
	perm, integer *givptr, integer *givcol, floatreal *givnum, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dlaed8_(integer *icompq, integer *k, integer *n, integer 
	*qsiz, floatreal *d__, floatreal *q, integer *ldq, integer *indxq, 
	floatreal *rho, integer *cutpnt, floatreal *z__, floatreal *dlamda, 
	 floatreal *q2, integer *ldq2, floatreal *w, integer *perm, integer 
	*givptr, integer *givcol, floatreal *givnum, integer *indxp, integer 
	*indx, integer *info);

/* Subroutine */ int dlaed9_(integer *k, integer *kstart, integer *kstop, 
	integer *n, floatreal *d__, floatreal *q, integer *ldq, floatreal *
	rho, floatreal *dlamda, floatreal *w, floatreal *s, integer *lds, 
	integer *info);

/* Subroutine */ int dlaeda_(integer *n, integer *tlvls, integer *curlvl, 
	integer *curpbm, integer *prmptr, integer *perm, integer *givptr, 
	integer *givcol, floatreal *givnum, floatreal *q, integer *qptr, 
	floatreal *z__, floatreal *ztemp, integer *info);

/* Subroutine */ int dlaein_(logical *rightv, logical *noinit, integer *n, 
	floatreal *h__, integer *ldh, floatreal *wr, floatreal *wi, 
	floatreal *vr, floatreal *vi, floatreal *b, integer *ldb, 
	floatreal *work, floatreal *eps3, floatreal *smlnum, floatreal *
	bignum, integer *info);

/* Subroutine */ int dlaev2_(floatreal *a, floatreal *b, floatreal *c__, 
	floatreal *rt1, floatreal *rt2, floatreal *cs1, floatreal *sn1);
...
/* Subroutine */ int dlag2_(floatreal *a, integer *lda, floatreal *b, 
	integer *ldb, floatreal *safmin, floatreal *scale1, floatreal *
	scale2, floatreal *wr1, floatreal *wr2, floatreal *wi);

/* Subroutine */ int dlag2s_(integer *m, integer *n, floatreal *a, integer *
	lda, real *sa, integer *ldsa, integer *info);

/* Subroutine */ int dlags2_(logical *upper, floatreal *a1, floatreal *a2, 
	floatreal *a3, floatreal *b1, floatreal *b2, floatreal *b3, 
	floatreal *csu, floatreal *snu, floatreal *csv, floatreal *snv, 
	floatreal *csq, floatreal *snq);

/* Subroutine */ int dlagtf_(integer *n, floatreal *a, floatreal *lambda, 
	floatreal *b, floatreal *c__, floatreal *tol, floatreal *d__, 
	integer *in, integer *info);

/* Subroutine */ int dlagtm_(char *trans, integer *n, integer *nrhs, 
	floatreal *alpha, floatreal *dl, floatreal *d__, floatreal *du, 
	floatreal *x, integer *ldx, floatreal *beta, floatreal *b, integer 
	*ldb);

/* Subroutine */ int dlagts_(integer *job, integer *n, floatreal *a, 
	floatreal *b, floatreal *c__, floatreal *d__, integer *in, 
	floatreal *y, floatreal *tol, integer *info);

/* Subroutine */ int dlagv2_(floatreal *a, integer *lda, floatreal *b, 
	integer *ldb, floatreal *alphar, floatreal *alphai, floatreal *
	beta, floatreal *csl, floatreal *snl, floatreal *csr, floatreal *
	snr);
...
/* Subroutine */ int dlahrd_(integer *n, integer *k, integer *nb, floatreal *
	a, integer *lda, floatreal *tau, floatreal *t, integer *ldt, 
	floatreal *y, integer *ldy);

/* Subroutine */ int dlaic1_(integer *job, integer *j, floatreal *x, 
	floatreal *sest, floatreal *w, floatreal *gamma, floatreal *
	sestpr, floatreal *s, floatreal *c__);
...
/* Subroutine */ int dlals0_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, integer *nrhs, floatreal *b, integer *ldb, floatreal 
	*bx, integer *ldbx, integer *perm, integer *givptr, integer *givcol, 
	integer *ldgcol, floatreal *givnum, integer *ldgnum, floatreal *
	poles, floatreal *difl, floatreal *difr, floatreal *z__, integer *
	k, floatreal *c__, floatreal *s, floatreal *work, integer *info);

/* Subroutine */ int dlalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, floatreal *b, integer *ldb, floatreal *bx, integer *
	ldbx, floatreal *u, integer *ldu, floatreal *vt, integer *k, 
	floatreal *difl, floatreal *difr, floatreal *z__, floatreal *
	poles, integer *givptr, integer *givcol, integer *ldgcol, integer *
	perm, floatreal *givnum, floatreal *c__, floatreal *s, floatreal *
	work, integer *iwork, integer *info);

/* Subroutine */ int dlalsd_(char *uplo, integer *smlsiz, integer *n, integer 
	*nrhs, floatreal *d__, floatreal *e, floatreal *b, integer *ldb, 
	floatreal *rcond, integer *rank, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dlamrg_(integer *n1, integer *n2, floatreal *a, integer 
	*dtrd1, integer *dtrd2, integer *index);

integer dlaneg_(integer *n, floatreal *d__, floatreal *lld, floatreal *
	sigma, floatreal *pivmin, integer *r__);

floatreal dlangb_(char *norm, integer *n, integer *kl, integer *ku, 
	floatreal *ab, integer *ldab, floatreal *work);

floatreal dlange_(char *norm, integer *m, integer *n, floatreal *a, integer 
	*lda, floatreal *work);

floatreal dlangt_(char *norm, integer *n, floatreal *dl, floatreal *d__, 
	floatreal *du);

floatreal dlanhs_(char *norm, integer *n, floatreal *a, integer *lda, 
	floatreal *work);

floatreal dlansb_(char *norm, char *uplo, integer *n, integer *k, floatreal 
	*ab, integer *ldab, floatreal *work);

floatreal dlansf_(char *norm, char *transr, char *uplo, integer *n, 
	floatreal *a, floatreal *work);

floatreal dlansp_(char *norm, char *uplo, integer *n, floatreal *ap, 
	floatreal *work);

floatreal dlanst_(char *norm, integer *n, floatreal *d__, floatreal *e);

floatreal dlansy_(char *norm, char *uplo, integer *n, floatreal *a, integer 
	*lda, floatreal *work);

floatreal dlantb_(char *norm, char *uplo, char *diag, integer *n, integer *k, 
	 floatreal *ab, integer *ldab, floatreal *work);

floatreal dlantp_(char *norm, char *uplo, char *diag, integer *n, floatreal 
	*ap, floatreal *work);

floatreal dlantr_(char *norm, char *uplo, char *diag, integer *m, integer *n, 
...
/* Subroutine */ int dlapll_(integer *n, floatreal *x, integer *incx, 
	floatreal *y, integer *incy, floatreal *ssmin);

/* Subroutine */ int dlapmt_(logical *forwrd, integer *m, integer *n, 
	floatreal *x, integer *ldx, integer *k);

floatreal dlapy2_(floatreal *x, floatreal *y);

floatreal dlapy3_(floatreal *x, floatreal *y, floatreal *z__);

/* Subroutine */ int dlaqgb_(integer *m, integer *n, integer *kl, integer *ku, 
	 floatreal *ab, integer *ldab, floatreal *r__, floatreal *c__, 
	floatreal *rowcnd, floatreal *colcnd, floatreal *amax, char *equed);

/* Subroutine */ int dlaqge_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *r__, floatreal *c__, floatreal *rowcnd, floatreal 
	*colcnd, floatreal *amax, char *equed);

/* Subroutine */ int dlaqp2_(integer *m, integer *n, integer *offset, 
	floatreal *a, integer *lda, integer *jpvt, floatreal *tau, 
	floatreal *vn1, floatreal *vn2, floatreal *work);

/* Subroutine */ int dlaqps_(integer *m, integer *n, integer *offset, integer 
	*nb, integer *kb, floatreal *a, integer *lda, integer *jpvt, 
	floatreal *tau, floatreal *vn1, floatreal *vn2, floatreal *auxv, 
	floatreal *f, integer *ldf);
...
/* Subroutine */ int dlaqsb_(char *uplo, integer *n, integer *kd, floatreal *
	ab, integer *ldab, floatreal *s, floatreal *scond, floatreal *amax, 
	 char *equed);

/* Subroutine */ int dlaqsp_(char *uplo, integer *n, floatreal *ap, 
	floatreal *s, floatreal *scond, floatreal *amax, char *equed);

/* Subroutine */ int dlaqsy_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *s, floatreal *scond, floatreal *amax, char *equed);

/* Subroutine */ int dlaqtr_(logical *ltran, logical *lreal, integer *n, 
	floatreal *t, integer *ldt, floatreal *b, floatreal *w, floatreal 
	*scale, floatreal *x, floatreal *work, integer *info);

/* Subroutine */ int dlar1v_(integer *n, integer *b1, integer *bn, floatreal 
	*lambda, floatreal *d__, floatreal *l, floatreal *ld, floatreal *
	lld, floatreal *pivmin, floatreal *gaptol, floatreal *z__, logical 
	*wantnc, integer *negcnt, floatreal *ztz, floatreal *mingma, 
	integer *r__, integer *isuppz, floatreal *nrminv, floatreal *resid, 
	floatreal *rqcorr, floatreal *work);

/* Subroutine */ int dlar2v_(integer *n, floatreal *x, floatreal *y, 
	floatreal *z__, integer *incx, floatreal *c__, floatreal *s, 
	integer *incc);
...
/* Subroutine */ int dlarfg_(integer *n, floatreal *alpha, floatreal *x, 
...
/* Subroutine */ int dlargv_(integer *n, floatreal *x, integer *incx, 
	floatreal *y, integer *incy, floatreal *c__, integer *incc);

/* Subroutine */ int dlarnv_(integer *idist, integer *iseed, integer *n, 
	floatreal *x);

/* Subroutine */ int dlarra_(integer *n, floatreal *d__, floatreal *e, 
	floatreal *e2, floatreal *spltol, floatreal *tnrm, integer *nsplit, 
	 integer *isplit, integer *info);

/* Subroutine */ int dlarrb_(integer *n, floatreal *d__, floatreal *lld, 
	integer *ifirst, integer *ilast, floatreal *rtol1, floatreal *rtol2, 
	 integer *offset, floatreal *w, floatreal *wgap, floatreal *werr, 
	floatreal *work, integer *iwork, floatreal *pivmin, floatreal *
	spdiam, integer *twist, integer *info);

/* Subroutine */ int dlarrc_(char *jobt, integer *n, floatreal *vl, 
	floatreal *vu, floatreal *d__, floatreal *e, floatreal *pivmin, 
	integer *eigcnt, integer *lcnt, integer *rcnt, integer *info);

/* Subroutine */ int dlarrd_(char *range, char *order, integer *n, floatreal 
	*vl, floatreal *vu, integer *il, integer *iu, floatreal *gers, 
	floatreal *reltol, floatreal *d__, floatreal *e, floatreal *e2, 
	floatreal *pivmin, integer *nsplit, integer *isplit, integer *m, 
	floatreal *w, floatreal *werr, floatreal *wl, floatreal *wu, 
	integer *iblock, integer *indexw, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dlarre_(char *range, integer *n, floatreal *vl, 
	floatreal *vu, integer *il, integer *iu, floatreal *d__, floatreal 
	*e, floatreal *e2, floatreal *rtol1, floatreal *rtol2, floatreal *
	spltol, integer *nsplit, integer *isplit, integer *m, floatreal *w, 
	floatreal *werr, floatreal *wgap, integer *iblock, integer *indexw, 
	floatreal *gers, floatreal *pivmin, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dlarrf_(integer *n, floatreal *d__, floatreal *l, 
	floatreal *ld, integer *clstrt, integer *clend, floatreal *w, 
	floatreal *wgap, floatreal *werr, floatreal *spdiam, floatreal *
	clgapl, floatreal *clgapr, floatreal *pivmin, floatreal *sigma, 
	floatreal *dplus, floatreal *lplus, floatreal *work, integer *info);

/* Subroutine */ int dlarrj_(integer *n, floatreal *d__, floatreal *e2, 
	integer *ifirst, integer *ilast, floatreal *rtol, integer *offset, 
	floatreal *w, floatreal *werr, floatreal *work, integer *iwork, 
	floatreal *pivmin, floatreal *spdiam, integer *info);

/* Subroutine */ int dlarrk_(integer *n, integer *iw, floatreal *gl, 
	floatreal *gu, floatreal *d__, floatreal *e2, floatreal *pivmin, 
	floatreal *reltol, floatreal *w, floatreal *werr, integer *info);

/* Subroutine */ int dlarrr_(integer *n, floatreal *d__, floatreal *e, 
	integer *info);

/* Subroutine */ int dlarrv_(integer *n, floatreal *vl, floatreal *vu, 
	floatreal *d__, floatreal *l, floatreal *pivmin, integer *isplit, 
	integer *m, integer *dol, integer *dou, floatreal *minrgp, 
	floatreal *rtol1, floatreal *rtol2, floatreal *w, floatreal *werr, 
	 floatreal *wgap, integer *iblock, integer *indexw, floatreal *gers, 
	 floatreal *z__, integer *ldz, integer *isuppz, floatreal *work, 
	integer *iwork, integer *info);

/* Subroutine */ int dlarscl2_(integer *m, integer *n, floatreal *d__, 
	floatreal *x, integer *ldx);

/* Subroutine */ int dlartg_(floatreal *f, floatreal *g, floatreal *cs, 
	floatreal *sn, floatreal *r__);

/* Subroutine */ int dlartv_(integer *n, floatreal *x, integer *incx, 
	floatreal *y, integer *incy, floatreal *c__, floatreal *s, integer 
	*incc);

/* Subroutine */ int dlaruv_(integer *iseed, integer *n, floatreal *x);

/* Subroutine */ int dlarz_(char *side, integer *m, integer *n, integer *l, 
	floatreal *v, integer *incv, floatreal *tau, floatreal *c__, 
	integer *ldc, floatreal *work);

/* Subroutine */ int dlarzb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, integer *l, floatreal *v, 
	 integer *ldv, floatreal *t, integer *ldt, floatreal *c__, integer *
	ldc, floatreal *work, integer *ldwork);
...
/* Subroutine */ int dlascl2_(integer *m, integer *n, floatreal *d__, 
	floatreal *x, integer *ldx);

/* Subroutine */ int dlasd0_(integer *n, integer *sqre, floatreal *d__, 
	floatreal *e, floatreal *u, integer *ldu, floatreal *vt, integer *
	ldvt, integer *smlsiz, integer *iwork, floatreal *work, integer *
	info);

/* Subroutine */ int dlasd1_(integer *nl, integer *nr, integer *sqre, 
	floatreal *d__, floatreal *alpha, floatreal *beta, floatreal *u, 
	integer *ldu, floatreal *vt, integer *ldvt, integer *idxq, integer *
	iwork, floatreal *work, integer *info);

/* Subroutine */ int dlasd2_(integer *nl, integer *nr, integer *sqre, integer 
	*k, floatreal *d__, floatreal *z__, floatreal *alpha, floatreal *
	beta, floatreal *u, integer *ldu, floatreal *vt, integer *ldvt, 
	floatreal *dsigma, floatreal *u2, integer *ldu2, floatreal *vt2, 
	integer *ldvt2, integer *idxp, integer *idx, integer *idxc, integer *
	idxq, integer *coltyp, integer *info);

/* Subroutine */ int dlasd3_(integer *nl, integer *nr, integer *sqre, integer 
	*k, floatreal *d__, floatreal *q, integer *ldq, floatreal *dsigma, 
	floatreal *u, integer *ldu, floatreal *u2, integer *ldu2, 
	floatreal *vt, integer *ldvt, floatreal *vt2, integer *ldvt2, 
	integer *idxc, integer *ctot, floatreal *z__, integer *info);

/* Subroutine */ int dlasd4_(integer *n, integer *i__, floatreal *d__, 
	floatreal *z__, floatreal *delta, floatreal *rho, floatreal *
	sigma, floatreal *work, integer *info);

/* Subroutine */ int dlasd5_(integer *i__, floatreal *d__, floatreal *z__, 
	floatreal *delta, floatreal *rho, floatreal *dsigma, floatreal *
	work);

/* Subroutine */ int dlasd6_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, floatreal *d__, floatreal *vf, floatreal *vl, 
	floatreal *alpha, floatreal *beta, integer *idxq, integer *perm, 
	integer *givptr, integer *givcol, integer *ldgcol, floatreal *givnum, 
	 integer *ldgnum, floatreal *poles, floatreal *difl, floatreal *
	difr, floatreal *z__, integer *k, floatreal *c__, floatreal *s, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dlasd7_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, integer *k, floatreal *d__, floatreal *z__, 
	floatreal *zw, floatreal *vf, floatreal *vfw, floatreal *vl, 
	floatreal *vlw, floatreal *alpha, floatreal *beta, floatreal *
	dsigma, integer *idx, integer *idxp, integer *idxq, integer *perm, 
	integer *givptr, integer *givcol, integer *ldgcol, floatreal *givnum, 
	 integer *ldgnum, floatreal *c__, floatreal *s, integer *info);

/* Subroutine */ int dlasd8_(integer *icompq, integer *k, floatreal *d__, 
	floatreal *z__, floatreal *vf, floatreal *vl, floatreal *difl, 
	floatreal *difr, integer *lddifr, floatreal *dsigma, floatreal *
	work, integer *info);

/* Subroutine */ int dlasda_(integer *icompq, integer *smlsiz, integer *n, 
	integer *sqre, floatreal *d__, floatreal *e, floatreal *u, integer 
	*ldu, floatreal *vt, integer *k, floatreal *difl, floatreal *difr, 
	floatreal *z__, floatreal *poles, integer *givptr, integer *givcol, 
	integer *ldgcol, integer *perm, floatreal *givnum, floatreal *c__, 
	floatreal *s, floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dlasdq_(char *uplo, integer *sqre, integer *n, integer *
	ncvt, integer *nru, integer *ncc, floatreal *d__, floatreal *e, 
	floatreal *vt, integer *ldvt, floatreal *u, integer *ldu, 
	floatreal *c__, integer *ldc, floatreal *work, integer *info);
...
/* Subroutine */ int dlasq6_(integer *i0, integer *n0, floatreal *z__, 
	integer *pp, floatreal *dmin__, floatreal *dmin1, floatreal *dmin2, 
	 floatreal *dn, floatreal *dnm1, floatreal *dnm2);
...
/* Subroutine */ int dlasyf_(char *uplo, integer *n, integer *nb, integer *kb, 
	 floatreal *a, integer *lda, integer *ipiv, floatreal *w, integer *
	ldw, integer *info);

/* Subroutine */ int dlat2s_(char *uplo, integer *n, floatreal *a, integer *
	lda, real *sa, integer *ldsa, integer *info);

/* Subroutine */ int dlatbs_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, integer *kd, floatreal *ab, integer *ldab, 
	floatreal *x, floatreal *scale, floatreal *cnorm, integer *info);

/* Subroutine */ int dlatdf_(integer *ijob, integer *n, floatreal *z__, 
	integer *ldz, floatreal *rhs, floatreal *rdsum, floatreal *rdscal, 
	integer *ipiv, integer *jpiv);

/* Subroutine */ int dlatps_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, floatreal *ap, floatreal *x, floatreal *scale, 
	floatreal *cnorm, integer *info);

/* Subroutine */ int dlatrd_(char *uplo, integer *n, integer *nb, floatreal *
	a, integer *lda, floatreal *e, floatreal *tau, floatreal *w, 
	integer *ldw);

/* Subroutine */ int dlatrs_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, floatreal *a, integer *lda, floatreal *x, 
	floatreal *scale, floatreal *cnorm, integer *info);

/* Subroutine */ int dlatrz_(integer *m, integer *n, integer *l, floatreal *
	a, integer *lda, floatreal *tau, floatreal *work);

/* Subroutine */ int dlatzm_(char *side, integer *m, integer *n, floatreal *
	v, integer *incv, floatreal *tau, floatreal *c1, floatreal *c2, 
	integer *ldc, floatreal *work);

/* Subroutine */ int dlauu2_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *info);

/* Subroutine */ int dlauum_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *info);

/* Subroutine */ int dopgtr_(char *uplo, integer *n, floatreal *ap, 
	floatreal *tau, floatreal *q, integer *ldq, floatreal *work, 
	integer *info);

/* Subroutine */ int dopmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, floatreal *ap, floatreal *tau, floatreal *c__, integer 
	*ldc, floatreal *work, integer *info);

/* Subroutine */ int dorg2l_(integer *m, integer *n, integer *k, floatreal *
...
/* Subroutine */ int dorglq_(integer *m, integer *n, integer *k, floatreal *
	a, integer *lda, floatreal *tau, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dorgql_(integer *m, integer *n, integer *k, floatreal *
	a, integer *lda, floatreal *tau, floatreal *work, integer *lwork, 
	integer *info);
...
/* Subroutine */ int dorgr2_(integer *m, integer *n, integer *k, floatreal *
	a, integer *lda, floatreal *tau, floatreal *work, integer *info);

/* Subroutine */ int dorgrq_(integer *m, integer *n, integer *k, floatreal *
	a, integer *lda, floatreal *tau, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dorgtr_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *lwork, integer *info);
...
/* Subroutine */ int dormr3_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, floatreal *a, integer *lda, floatreal *tau, 
	floatreal *c__, integer *ldc, floatreal *work, integer *info);
...
/* Subroutine */ int dormtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, floatreal *a, integer *lda, floatreal *tau, floatreal *
	c__, integer *ldc, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dpbcon_(char *uplo, integer *n, integer *kd, floatreal *
	ab, integer *ldab, floatreal *anorm, floatreal *rcond, floatreal *
	work, integer *iwork, integer *info);

/* Subroutine */ int dpbequ_(char *uplo, integer *n, integer *kd, floatreal *
	ab, integer *ldab, floatreal *s, floatreal *scond, floatreal *amax, 
	 integer *info);

/* Subroutine */ int dpbrfs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, floatreal *ab, integer *ldab, floatreal *afb, integer *ldafb, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	ferr, floatreal *berr, floatreal *work, integer *iwork, integer *
	info);

/* Subroutine */ int dpbstf_(char *uplo, integer *n, integer *kd, floatreal *
	ab, integer *ldab, integer *info);

/* Subroutine */ int dpbsv_(char *uplo, integer *n, integer *kd, integer *
	nrhs, floatreal *ab, integer *ldab, floatreal *b, integer *ldb, 
	integer *info);

/* Subroutine */ int dpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
	integer *nrhs, floatreal *ab, integer *ldab, floatreal *afb, 
	integer *ldafb, char *equed, floatreal *s, floatreal *b, integer *
	ldb, floatreal *x, integer *ldx, floatreal *rcond, floatreal *ferr, 
	 floatreal *berr, floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dpbtf2_(char *uplo, integer *n, integer *kd, floatreal *
	ab, integer *ldab, integer *info);

/* Subroutine */ int dpbtrf_(char *uplo, integer *n, integer *kd, floatreal *
	ab, integer *ldab, integer *info);
...
/* Subroutine */ int dpftrf_(char *transr, char *uplo, integer *n, floatreal 
	*a, integer *info);

/* Subroutine */ int dpftri_(char *transr, char *uplo, integer *n, floatreal 
	*a, integer *info);

/* Subroutine */ int dpftrs_(char *transr, char *uplo, integer *n, integer *
	nrhs, floatreal *a, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dpocon_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *anorm, floatreal *rcond, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dpoequ_(integer *n, floatreal *a, integer *lda, 
	floatreal *s, floatreal *scond, floatreal *amax, integer *info);

/* Subroutine */ int dpoequb_(integer *n, floatreal *a, integer *lda, 
	floatreal *s, floatreal *scond, floatreal *amax, integer *info);

/* Subroutine */ int dporfs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	ferr, floatreal *berr, floatreal *work, integer *iwork, integer *
	info);
...
/* Subroutine */ int dporfsx_(char *uplo, char *equed, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	floatreal *s, floatreal *b, integer *ldb, floatreal *x, integer *
	ldx, floatreal *rcond, floatreal *berr, integer *n_err_bnds__, 
	floatreal *err_bnds_norm__, floatreal *err_bnds_comp__, integer *
	nparams, floatreal *params, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dposv_(char *uplo, integer *n, integer *nrhs, floatreal 
	*a, integer *lda, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dposvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	char *equed, floatreal *s, floatreal *b, integer *ldb, floatreal *
	x, integer *ldx, floatreal *rcond, floatreal *ferr, floatreal *
	berr, floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dposvxx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	char *equed, floatreal *s, floatreal *b, integer *ldb, floatreal *
	x, integer *ldx, floatreal *rcond, floatreal *rpvgrw, floatreal *
	berr, integer *n_err_bnds__, floatreal *err_bnds_norm__, floatreal *
	err_bnds_comp__, integer *nparams, floatreal *params, floatreal *
	work, integer *iwork, integer *info);

/* Subroutine */ int dpotf2_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *info);

/* Subroutine */ int dpotrf__(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *info);

/* Subroutine */ int dpotri_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *info);
...
/* Subroutine */ int dppcon_(char *uplo, integer *n, floatreal *ap, 
	floatreal *anorm, floatreal *rcond, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dppequ_(char *uplo, integer *n, floatreal *ap, 
	floatreal *s, floatreal *scond, floatreal *amax, integer *info);

/* Subroutine */ int dpprfs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *ap, floatreal *afp, floatreal *b, integer *ldb, 
	floatreal *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dppsv_(char *uplo, integer *n, integer *nrhs, floatreal 
	*ap, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dppsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatreal *ap, floatreal *afp, char *equed, floatreal *s, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	rcond, floatreal *ferr, floatreal *berr, floatreal *work, integer *
	iwork, integer *info);

/* Subroutine */ int dpptrf_(char *uplo, integer *n, floatreal *ap, integer *
	info);

/* Subroutine */ int dpptri_(char *uplo, integer *n, floatreal *ap, integer *
	info);

/* Subroutine */ int dpptrs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *ap, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dpstf2_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *piv, integer *rank, floatreal *tol, floatreal *work, 
	integer *info);

/* Subroutine */ int dpstrf_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *piv, integer *rank, floatreal *tol, floatreal *work, 
	integer *info);

/* Subroutine */ int dptcon_(integer *n, floatreal *d__, floatreal *e, 
	floatreal *anorm, floatreal *rcond, floatreal *work, integer *info);

/* Subroutine */ int dpteqr_(char *compz, integer *n, floatreal *d__, 
	floatreal *e, floatreal *z__, integer *ldz, floatreal *work, 
	integer *info);

/* Subroutine */ int dptrfs_(integer *n, integer *nrhs, floatreal *d__, 
	floatreal *e, floatreal *df, floatreal *ef, floatreal *b, integer 
	*ldb, floatreal *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	 floatreal *work, integer *info);

/* Subroutine */ int dptsv_(integer *n, integer *nrhs, floatreal *d__, 
	floatreal *e, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dptsvx_(char *fact, integer *n, integer *nrhs, 
	floatreal *d__, floatreal *e, floatreal *df, floatreal *ef, 
	floatreal *b, integer *ldb, floatreal *x, integer *ldx, floatreal *
	rcond, floatreal *ferr, floatreal *berr, floatreal *work, integer *
	info);

/* Subroutine */ int dpttrf_(integer *n, floatreal *d__, floatreal *e, 
	integer *info);

/* Subroutine */ int dpttrs_(integer *n, integer *nrhs, floatreal *d__, 
	floatreal *e, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dptts2_(integer *n, integer *nrhs, floatreal *d__, 
	floatreal *e, floatreal *b, integer *ldb);

/* Subroutine */ int drscl_(integer *n, floatreal *sa, floatreal *sx, 
	integer *incx);

/* Subroutine */ int dsbev_(char *jobz, char *uplo, integer *n, integer *kd, 
	floatreal *ab, integer *ldab, floatreal *w, floatreal *z__, 
	integer *ldz, floatreal *work, integer *info);

/* Subroutine */ int dsbevd_(char *jobz, char *uplo, integer *n, integer *kd, 
	floatreal *ab, integer *ldab, floatreal *w, floatreal *z__, 
	integer *ldz, floatreal *work, integer *lwork, integer *iwork, 
	integer *liwork, integer *info);

/* Subroutine */ int dsbevx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *kd, floatreal *ab, integer *ldab, floatreal *q, integer *
	ldq, floatreal *vl, floatreal *vu, integer *il, integer *iu, 
	floatreal *abstol, integer *m, floatreal *w, floatreal *z__, 
	integer *ldz, floatreal *work, integer *iwork, integer *ifail, 
	integer *info);

/* Subroutine */ int dsbgst_(char *vect, char *uplo, integer *n, integer *ka, 
	integer *kb, floatreal *ab, integer *ldab, floatreal *bb, integer *
	ldbb, floatreal *x, integer *ldx, floatreal *work, integer *info);

/* Subroutine */ int dsbgv_(char *jobz, char *uplo, integer *n, integer *ka, 
	integer *kb, floatreal *ab, integer *ldab, floatreal *bb, integer *
	ldbb, floatreal *w, floatreal *z__, integer *ldz, floatreal *work, 
	integer *info);
...
/* Subroutine */ int dsbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *ka, integer *kb, floatreal *ab, integer *ldab, floatreal *
	bb, integer *ldbb, floatreal *q, integer *ldq, floatreal *vl, 
	floatreal *vu, integer *il, integer *iu, floatreal *abstol, integer 
	*m, floatreal *w, floatreal *z__, integer *ldz, floatreal *work, 
	integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int dsbtrd_(char *vect, char *uplo, integer *n, integer *kd, 
	floatreal *ab, integer *ldab, floatreal *d__, floatreal *e, 
	floatreal *q, integer *ldq, floatreal *work, integer *info);

/* Subroutine */ int dsfrk_(char *transr, char *uplo, char *trans, integer *n, 
	 integer *k, floatreal *alpha, floatreal *a, integer *lda, 
	floatreal *beta, floatreal *c__);

/* Subroutine */ int dsgesv_(integer *n, integer *nrhs, floatreal *a, 
	integer *lda, integer *ipiv, floatreal *b, integer *ldb, floatreal *
	x, integer *ldx, floatreal *work, real *swork, integer *iter, 
	integer *info);

/* Subroutine */ int dspcon_(char *uplo, integer *n, floatreal *ap, integer *
	ipiv, floatreal *anorm, floatreal *rcond, floatreal *work, integer 
	*iwork, integer *info);

/* Subroutine */ int dspev_(char *jobz, char *uplo, integer *n, floatreal *
	ap, floatreal *w, floatreal *z__, integer *ldz, floatreal *work, 
	integer *info);

/* Subroutine */ int dspevd_(char *jobz, char *uplo, integer *n, floatreal *
	ap, floatreal *w, floatreal *z__, integer *ldz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dspevx_(char *jobz, char *range, char *uplo, integer *n, 
	floatreal *ap, floatreal *vl, floatreal *vu, integer *il, integer *
	iu, floatreal *abstol, integer *m, floatreal *w, floatreal *z__, 
	integer *ldz, floatreal *work, integer *iwork, integer *ifail, 
	integer *info);

/* Subroutine */ int dspgst_(integer *itype, char *uplo, integer *n, 
	floatreal *ap, floatreal *bp, integer *info);

/* Subroutine */ int dspgv_(integer *itype, char *jobz, char *uplo, integer *
	n, floatreal *ap, floatreal *bp, floatreal *w, floatreal *z__, 
	integer *ldz, floatreal *work, integer *info);
...
/* Subroutine */ int dspgvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, floatreal *ap, floatreal *bp, floatreal *vl, 
	floatreal *vu, integer *il, integer *iu, floatreal *abstol, integer 
	*m, floatreal *w, floatreal *z__, integer *ldz, floatreal *work, 
	integer *iwork, integer *ifail, integer *info);
...
/* Subroutine */ int dsprfs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *ap, floatreal *afp, integer *ipiv, floatreal *b, 
	integer *ldb, floatreal *x, integer *ldx, floatreal *ferr, 
	floatreal *berr, floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dspsv_(char *uplo, integer *n, integer *nrhs, floatreal 
	*ap, integer *ipiv, floatreal *b, integer *ldb, integer *info);

/* Subroutine */ int dspsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatreal *ap, floatreal *afp, integer *ipiv, floatreal *b, 
	integer *ldb, floatreal *x, integer *ldx, floatreal *rcond, 
	floatreal *ferr, floatreal *berr, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dsptrd_(char *uplo, integer *n, floatreal *ap, 
	floatreal *d__, floatreal *e, floatreal *tau, integer *info);

/* Subroutine */ int dsptrf_(char *uplo, integer *n, floatreal *ap, integer *
	ipiv, integer *info);

/* Subroutine */ int dsptri_(char *uplo, integer *n, floatreal *ap, integer *
	ipiv, floatreal *work, integer *info);

/* Subroutine */ int dsptrs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *ap, integer *ipiv, floatreal *b, integer *ldb, integer *
	info);

/* Subroutine */ int dstebz_(char *range, char *order, integer *n, floatreal 
	*vl, floatreal *vu, integer *il, integer *iu, floatreal *abstol, 
	floatreal *d__, floatreal *e, integer *m, integer *nsplit, 
	floatreal *w, integer *iblock, integer *isplit, floatreal *work, 
	integer *iwork, integer *info);

/* Subroutine */ int dstedc_(char *compz, integer *n, floatreal *d__, 
	floatreal *e, floatreal *z__, integer *ldz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dstegr_(char *jobz, char *range, integer *n, floatreal *
	d__, floatreal *e, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatreal *z__, integer *ldz, integer *isuppz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dstein_(integer *n, floatreal *d__, floatreal *e, 
	integer *m, floatreal *w, integer *iblock, integer *isplit, 
	floatreal *z__, integer *ldz, floatreal *work, integer *iwork, 
	integer *ifail, integer *info);

/* Subroutine */ int dstemr_(char *jobz, char *range, integer *n, floatreal *
	d__, floatreal *e, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, integer *m, floatreal *w, floatreal *z__, integer *ldz, 
	 integer *nzc, integer *isuppz, logical *tryrac, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dsteqr_(char *compz, integer *n, floatreal *d__, 
	floatreal *e, floatreal *z__, integer *ldz, floatreal *work, 
	integer *info);

/* Subroutine */ int dsterf_(integer *n, floatreal *d__, floatreal *e, 
	integer *info);

/* Subroutine */ int dstev_(char *jobz, integer *n, floatreal *d__, 
	floatreal *e, floatreal *z__, integer *ldz, floatreal *work, 
	integer *info);

/* Subroutine */ int dstevd_(char *jobz, integer *n, floatreal *d__, 
	floatreal *e, floatreal *z__, integer *ldz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dstevr_(char *jobz, char *range, integer *n, floatreal *
	d__, floatreal *e, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatreal *z__, integer *ldz, integer *isuppz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dstevx_(char *jobz, char *range, integer *n, floatreal *
	d__, floatreal *e, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatreal *z__, integer *ldz, floatreal *work, integer *iwork, 
	integer *ifail, integer *info);

/* Subroutine */ int dsycon_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *ipiv, floatreal *anorm, floatreal *rcond, floatreal *
	work, integer *iwork, integer *info);

/* Subroutine */ int dsyequb_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *s, floatreal *scond, floatreal *amax, floatreal *
	work, integer *info);

/* Subroutine */ int dsyev_(char *jobz, char *uplo, integer *n, floatreal *a, 
	 integer *lda, floatreal *w, floatreal *work, integer *lwork, 
	integer *info);

/* Subroutine */ int dsyevd_(char *jobz, char *uplo, integer *n, floatreal *
	a, integer *lda, floatreal *w, floatreal *work, integer *lwork, 
	integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int dsyevr_(char *jobz, char *range, char *uplo, integer *n, 
	floatreal *a, integer *lda, floatreal *vl, floatreal *vu, integer *
	il, integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatreal *z__, integer *ldz, integer *isuppz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);
...
/* Subroutine */ int dsyevx_(char *jobz, char *range, char *uplo, integer *n, 
	floatreal *a, integer *lda, floatreal *vl, floatreal *vu, integer *
	il, integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatreal *z__, integer *ldz, floatreal *work, integer *lwork, 
	integer *iwork, integer *ifail, integer *info);
...
/* Subroutine */ int dsygv_(integer *itype, char *jobz, char *uplo, integer *
	n, floatreal *a, integer *lda, floatreal *b, integer *ldb, 
	floatreal *w, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dsygvd_(integer *itype, char *jobz, char *uplo, integer *
	n, floatreal *a, integer *lda, floatreal *b, integer *ldb, 
	floatreal *w, floatreal *work, integer *lwork, integer *iwork, 
	integer *liwork, integer *info);

/* Subroutine */ int dsygvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, floatreal *a, integer *lda, floatreal *b, integer 
	*ldb, floatreal *vl, floatreal *vu, integer *il, integer *iu, 
	floatreal *abstol, integer *m, floatreal *w, floatreal *z__, 
	integer *ldz, floatreal *work, integer *lwork, integer *iwork, 
	integer *ifail, integer *info);
...
/* Subroutine */ int dsyrfsx_(char *uplo, char *equed, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	integer *ipiv, floatreal *s, floatreal *b, integer *ldb, floatreal 
	*x, integer *ldx, floatreal *rcond, floatreal *berr, integer *
	n_err_bnds__, floatreal *err_bnds_norm__, floatreal *
	err_bnds_comp__, integer *nparams, floatreal *params, floatreal *
	work, integer *iwork, integer *info);

/* Subroutine */ int dsysv_(char *uplo, integer *n, integer *nrhs, floatreal 
	*a, integer *lda, integer *ipiv, floatreal *b, integer *ldb, 
	floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dsysvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	integer *ipiv, floatreal *b, integer *ldb, floatreal *x, integer *
	ldx, floatreal *rcond, floatreal *ferr, floatreal *berr, 
	floatreal *work, integer *lwork, integer *iwork, integer *info);

/* Subroutine */ int dsysvxx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatreal *a, integer *lda, floatreal *af, integer *ldaf, 
	integer *ipiv, char *equed, floatreal *s, floatreal *b, integer *
	ldb, floatreal *x, integer *ldx, floatreal *rcond, floatreal *
	rpvgrw, floatreal *berr, integer *n_err_bnds__, floatreal *
	err_bnds_norm__, floatreal *err_bnds_comp__, integer *nparams, 
	floatreal *params, floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dsytd2_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *d__, floatreal *e, floatreal *tau, integer *info);

/* Subroutine */ int dsytf2_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *ipiv, integer *info);

/* Subroutine */ int dsytrd_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *d__, floatreal *e, floatreal *tau, floatreal *
	work, integer *lwork, integer *info);

/* Subroutine */ int dsytrf_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *ipiv, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dsytri_(char *uplo, integer *n, floatreal *a, integer *
	lda, integer *ipiv, floatreal *work, integer *info);
...
/* Subroutine */ int dtbcon_(char *norm, char *uplo, char *diag, integer *n, 
	integer *kd, floatreal *ab, integer *ldab, floatreal *rcond, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dtbrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *kd, integer *nrhs, floatreal *ab, integer *ldab, floatreal 
	*b, integer *ldb, floatreal *x, integer *ldx, floatreal *ferr, 
	floatreal *berr, floatreal *work, integer *iwork, integer *info);
...
/* Subroutine */ int dtfsm_(char *transr, char *side, char *uplo, char *trans, 
	 char *diag, integer *m, integer *n, floatreal *alpha, floatreal *a, 
	 floatreal *b, integer *ldb);

/* Subroutine */ int dtftri_(char *transr, char *uplo, char *diag, integer *n, 
	 floatreal *a, integer *info);

/* Subroutine */ int dtfttp_(char *transr, char *uplo, integer *n, floatreal 
	*arf, floatreal *ap, integer *info);

/* Subroutine */ int dtfttr_(char *transr, char *uplo, integer *n, floatreal 
	*arf, floatreal *a, integer *lda, integer *info);

/* Subroutine */ int dtgevc_(char *side, char *howmny, logical *select, 
	integer *n, floatreal *s, integer *lds, floatreal *p, integer *ldp, 
	floatreal *vl, integer *ldvl, floatreal *vr, integer *ldvr, integer 
	*mm, integer *m, floatreal *work, integer *info);

/* Subroutine */ int dtgex2_(logical *wantq, logical *wantz, integer *n, 
	floatreal *a, integer *lda, floatreal *b, integer *ldb, floatreal *
	q, integer *ldq, floatreal *z__, integer *ldz, integer *j1, integer *
	n1, integer *n2, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dtgexc_(logical *wantq, logical *wantz, integer *n, 
	floatreal *a, integer *lda, floatreal *b, integer *ldb, floatreal *
	q, integer *ldq, floatreal *z__, integer *ldz, integer *ifst, 
	integer *ilst, floatreal *work, integer *lwork, integer *info);

/* Subroutine */ int dtgsen_(integer *ijob, logical *wantq, logical *wantz, 
	logical *select, integer *n, floatreal *a, integer *lda, floatreal *
	b, integer *ldb, floatreal *alphar, floatreal *alphai, floatreal *
	beta, floatreal *q, integer *ldq, floatreal *z__, integer *ldz, 
	integer *m, floatreal *pl, floatreal *pr, floatreal *dif, 
	floatreal *work, integer *lwork, integer *iwork, integer *liwork, 
	integer *info);

/* Subroutine */ int dtgsja_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *p, integer *n, integer *k, integer *l, floatreal *a, 
	integer *lda, floatreal *b, integer *ldb, floatreal *tola, 
	floatreal *tolb, floatreal *alpha, floatreal *beta, floatreal *u, 
	integer *ldu, floatreal *v, integer *ldv, floatreal *q, integer *
	ldq, floatreal *work, integer *ncycle, integer *info);

/* Subroutine */ int dtgsna_(char *job, char *howmny, logical *select, 
	integer *n, floatreal *a, integer *lda, floatreal *b, integer *ldb, 
	floatreal *vl, integer *ldvl, floatreal *vr, integer *ldvr, 
	floatreal *s, floatreal *dif, integer *mm, integer *m, floatreal *
	work, integer *lwork, integer *iwork, integer *info);

/* Subroutine */ int dtgsy2_(char *trans, integer *ijob, integer *m, integer *
	n, floatreal *a, integer *lda, floatreal *b, integer *ldb, 
	floatreal *c__, integer *ldc, floatreal *d__, integer *ldd, 
	floatreal *e, integer *lde, floatreal *f, integer *ldf, floatreal *
	scale, floatreal *rdsum, floatreal *rdscal, integer *iwork, integer 
	*pq, integer *info);
...
/* Subroutine */ int dtgsyl_(char *trans, integer *ijob, integer *m, integer *
	...
	floatreal *c__, integer *ldc, floatreal *d__, integer *ldd, 
	floatreal *e, integer *lde, floatreal *f, integer *ldf, floatreal *
	scale, floatreal *dif, floatreal *work, integer *lwork, integer *
	iwork, integer *info);

/* Subroutine */ int dtpcon_(char *norm, char *uplo, char *diag, integer *n, 
	floatreal *ap, floatreal *rcond, floatreal *work, integer *iwork, 
	integer *info);

/* Subroutine */ int dtprfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, floatreal *ap, floatreal *b, integer *ldb, 
	floatreal *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dtptri_(char *uplo, char *diag, integer *n, floatreal *
	ap, integer *info);

/* Subroutine */ int dtptrs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, floatreal *ap, floatreal *b, integer *ldb, integer *
	info);

/* Subroutine */ int dtpttf_(char *transr, char *uplo, integer *n, floatreal 
	*ap, floatreal *arf, integer *info);

/* Subroutine */ int dtpttr_(char *uplo, integer *n, floatreal *ap, 
	floatreal *a, integer *lda, integer *info);

/* Subroutine */ int dtrcon_(char *norm, char *uplo, char *diag, integer *n, 
	floatreal *a, integer *lda, floatreal *rcond, floatreal *work, 
	integer *iwork, integer *info);
...
/* Subroutine */ int dtrrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, floatreal *a, integer *lda, floatreal *b, integer *
	ldb, floatreal *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatreal *work, integer *iwork, integer *info);

/* Subroutine */ int dtrsen_(char *job, char *compq, logical *select, integer 
	*n, floatreal *t, integer *ldt, floatreal *q, integer *ldq, 
	floatreal *wr, floatreal *wi, integer *m, floatreal *s, floatreal 
	*sep, floatreal *work, integer *lwork, integer *iwork, integer *
	liwork, integer *info);

/* Subroutine */ int dtrsna_(char *job, char *howmny, logical *select, 
	integer *n, floatreal *t, integer *ldt, floatreal *vl, integer *
	ldvl, floatreal *vr, integer *ldvr, floatreal *s, floatreal *sep, 
	integer *mm, integer *m, floatreal *work, integer *ldwork, integer *
	iwork, integer *info);

/* Subroutine */ int dtrsyl_(char *trana, char *tranb, integer *isgn, integer 
	*m, integer *n, floatreal *a, integer *lda, floatreal *b, integer *
	ldb, floatreal *c__, integer *ldc, floatreal *scale, integer *info);

/* Subroutine */ int dtrti2_(char *uplo, char *diag, integer *n, floatreal *
	a, integer *lda, integer *info);

/* Subroutine */ int dtrtri_(char *uplo, char *diag, integer *n, floatreal *
	a, integer *lda, integer *info);
...
/* Subroutine */ int dtrttf_(char *transr, char *uplo, integer *n, floatreal 
	*a, integer *lda, floatreal *arf, integer *info);

/* Subroutine */ int dtrttp_(char *uplo, integer *n, floatreal *a, integer *
	lda, floatreal *ap, integer *info);

/* Subroutine */ int dtzrqf_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, integer *info);

/* Subroutine */ int dtzrzf_(integer *m, integer *n, floatreal *a, integer *
	lda, floatreal *tau, floatreal *work, integer *lwork, integer *info);

floatreal dzsum1_(integer *n, floatcomplex *cx, integer *incx);
...
integer iladlc_(integer *m, integer *n, floatreal *a, integer *lda);
...
integer ilazlc_(integer *m, integer *n, floatcomplex *a, integer *lda);

integer ilazlr_(integer *m, integer *n, floatcomplex *a, integer *lda);

integer iparmq_(integer *ispec, char *name__, char *opts, integer *n, integer 
	*ilo, integer *ihi, integer *lwork);

integer izmax1_(integer *n, floatcomplex *cx, integer *incx);
...
floatreal scsum1_(integer *n, complex *cx, integer *incx);
...
floatreal sla_gbrcond__(char *trans, integer *n, integer *kl, integer *ku, 
...
floatreal sla_gbrpvgrw__(integer *n, integer *kl, integer *ku, integer *
...
floatreal sla_gercond__(char *trans, integer *n, real *a, integer *lda, real 
...
floatreal sla_porcond__(char *uplo, integer *n, real *a, integer *lda, real *
...
floatreal sla_porpvgrw__(char *uplo, integer *ncols, real *a, integer *lda, 
	real *af, integer *ldaf, real *work, ftnlen uplo_len);

floatreal sla_rpvgrw__(integer *n, integer *ncols, real *a, integer *lda, 
...
floatreal sla_syrcond__(char *uplo, integer *n, real *a, integer *lda, real *
	af, integer *ldaf, integer *ipiv, integer *cmode, real *c__, integer *
...
floatreal sla_syrpvgrw__(char *uplo, integer *n, integer *info, real *a, 
...
floatreal slangb_(char *norm, integer *n, integer *kl, integer *ku, real *ab, 
	 integer *ldab, real *work);

floatreal slange_(char *norm, integer *m, integer *n, real *a, integer *lda, 
	real *work);

floatreal slangt_(char *norm, integer *n, real *dl, real *d__, real *du);

floatreal slanhs_(char *norm, integer *n, real *a, integer *lda, real *work);

floatreal slansb_(char *norm, char *uplo, integer *n, integer *k, real *ab, 
	integer *ldab, real *work);

floatreal slansf_(char *norm, char *transr, char *uplo, integer *n, real *a, 
	real *work);

floatreal slansp_(char *norm, char *uplo, integer *n, real *ap, real *work);

floatreal slanst_(char *norm, integer *n, real *d__, real *e);

floatreal slansy_(char *norm, char *uplo, integer *n, real *a, integer *lda, 
	real *work);

floatreal slantb_(char *norm, char *uplo, char *diag, integer *n, integer *k, 
	 real *ab, integer *ldab, real *work);

floatreal slantp_(char *norm, char *uplo, char *diag, integer *n, real *ap, 
	real *work);

floatreal slantr_(char *norm, char *uplo, char *diag, integer *m, integer *n, 
...
floatreal slapy3_(real *x, real *y, real *z__);
...
/* Subroutine */ int zbdsqr_(char *uplo, integer *n, integer *ncvt, integer *
	nru, integer *ncc, floatreal *d__, floatreal *e, floatcomplex *vt, 
	integer *ldvt, floatcomplex *u, integer *ldu, floatcomplex *c__, 
	integer *ldc, floatreal *rwork, integer *info);

/* Subroutine */ int zcgesv_(integer *n, integer *nrhs, floatcomplex *a, 
	integer *lda, integer *ipiv, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatcomplex *work, complex *swork, 
	floatreal *rwork, integer *iter, integer *info);

/* Subroutine */ int zcposv_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatcomplex *work, complex *swork, 
	floatreal *rwork, integer *iter, integer *info);

/* Subroutine */ int zdrscl_(integer *n, floatreal *sa, floatcomplex *sx, 
	integer *incx);

/* Subroutine */ int zgbbrd_(char *vect, integer *m, integer *n, integer *ncc, 
	 integer *kl, integer *ku, floatcomplex *ab, integer *ldab, 
	floatreal *d__, floatreal *e, floatcomplex *q, integer *ldq, 
	floatcomplex *pt, integer *ldpt, floatcomplex *c__, integer *ldc, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zgbcon_(char *norm, integer *n, integer *kl, integer *ku, 
	 floatcomplex *ab, integer *ldab, integer *ipiv, floatreal *anorm, 
	floatreal *rcond, floatcomplex *work, floatreal *rwork, integer *
	info);

/* Subroutine */ int zgbequ_(integer *m, integer *n, integer *kl, integer *ku, 
	 floatcomplex *ab, integer *ldab, floatreal *r__, floatreal *c__, 
	floatreal *rowcnd, floatreal *colcnd, floatreal *amax, integer *
	info);

/* Subroutine */ int zgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, floatcomplex *ab, integer *ldab, floatreal *r__, floatreal *
	c__, floatreal *rowcnd, floatreal *colcnd, floatreal *amax, 
	integer *info);

/* Subroutine */ int zgbrfs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, floatcomplex *ab, integer *ldab, floatcomplex *
	afb, integer *ldafb, integer *ipiv, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zgbrfsx_(char *trans, char *equed, integer *n, integer *
	kl, integer *ku, integer *nrhs, floatcomplex *ab, integer *ldab, 
	floatcomplex *afb, integer *ldafb, integer *ipiv, floatreal *r__, 
	floatreal *c__, floatcomplex *b, integer *ldb, floatcomplex *x, 
	integer *ldx, floatreal *rcond, floatreal *berr, integer *
	n_err_bnds__, floatreal *err_bnds_norm__, floatreal *
	err_bnds_comp__, integer *nparams, floatreal *params, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, floatcomplex *ab, integer *ldab, integer *ipiv, floatcomplex *
	b, integer *ldb, integer *info);

/* Subroutine */ int zgbsvx_(char *fact, char *trans, integer *n, integer *kl, 
	 integer *ku, integer *nrhs, floatcomplex *ab, integer *ldab, 
	floatcomplex *afb, integer *ldafb, integer *ipiv, char *equed, 
	floatreal *r__, floatreal *c__, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *rcond, floatreal *ferr, 
	floatreal *berr, floatcomplex *work, floatreal *rwork, integer *
	info);
...
/* Subroutine */ int zgbsvxx_(char *fact, char *trans, integer *n, integer *
	...
	floatcomplex *afb, integer *ldafb, integer *ipiv, char *equed, 
	floatreal *r__, floatreal *c__, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *rcond, floatreal *rpvgrw, 
	 floatreal *berr, integer *n_err_bnds__, floatreal *err_bnds_norm__, 
	 floatreal *err_bnds_comp__, integer *nparams, floatreal *params, 
	floatcomplex *work, floatreal *rwork, integer *info);
...
/* Subroutine */ int zgbtrs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, floatcomplex *ab, integer *ldab, integer *ipiv, 
	floatcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int zgebak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, floatreal *scale, integer *m, floatcomplex *v, 
	integer *ldv, integer *info);

/* Subroutine */ int zgebal_(char *job, integer *n, floatcomplex *a, integer 
	*lda, integer *ilo, integer *ihi, floatreal *scale, integer *info);

/* Subroutine */ int zgebd2_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *d__, floatreal *e, floatcomplex *tauq, 
	floatcomplex *taup, floatcomplex *work, integer *info);

/* Subroutine */ int zgebrd_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *d__, floatreal *e, floatcomplex *tauq, 
	floatcomplex *taup, floatcomplex *work, integer *lwork, integer *
	info);

/* Subroutine */ int zgecon_(char *norm, integer *n, floatcomplex *a, 
	integer *lda, floatreal *anorm, floatreal *rcond, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zgeequ_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *r__, floatreal *c__, floatreal *rowcnd, 
	floatreal *colcnd, floatreal *amax, integer *info);

/* Subroutine */ int zgeequb_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *r__, floatreal *c__, floatreal *rowcnd, 
	floatreal *colcnd, floatreal *amax, integer *info);

/* Subroutine */ int zgees_(char *jobvs, char *sort, L_fp select, integer *n, 
	floatcomplex *a, integer *lda, integer *sdim, floatcomplex *w, 
	floatcomplex *vs, integer *ldvs, floatcomplex *work, integer *lwork, 
	 floatreal *rwork, logical *bwork, integer *info);

/* Subroutine */ int zgeesx_(char *jobvs, char *sort, L_fp select, char *
	sense, integer *n, floatcomplex *a, integer *lda, integer *sdim, 
	floatcomplex *w, floatcomplex *vs, integer *ldvs, floatreal *
	rconde, floatreal *rcondv, floatcomplex *work, integer *lwork, 
	floatreal *rwork, logical *bwork, integer *info);

/* Subroutine */ int zgeev_(char *jobvl, char *jobvr, integer *n, 
	floatcomplex *a, integer *lda, floatcomplex *w, floatcomplex *vl, 
	integer *ldvl, floatcomplex *vr, integer *ldvr, floatcomplex *work, 
	integer *lwork, floatreal *rwork, integer *info);

/* Subroutine */ int zgeevx_(char *balanc, char *jobvl, char *jobvr, char *
	sense, integer *n, floatcomplex *a, integer *lda, floatcomplex *w, 
	floatcomplex *vl, integer *ldvl, floatcomplex *vr, integer *ldvr, 
	integer *ilo, integer *ihi, floatreal *scale, floatreal *abnrm, 
	floatreal *rconde, floatreal *rcondv, floatcomplex *work, integer *
	lwork, floatreal *rwork, integer *info);

/* Subroutine */ int zgegs_(char *jobvsl, char *jobvsr, integer *n, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *alpha, floatcomplex *beta, floatcomplex *vsl, 
	integer *ldvsl, floatcomplex *vsr, integer *ldvsr, floatcomplex *
	work, integer *lwork, floatreal *rwork, integer *info);

/* Subroutine */ int zgegv_(char *jobvl, char *jobvr, integer *n, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *alpha, floatcomplex *beta, floatcomplex *vl, integer 
	*ldvl, floatcomplex *vr, integer *ldvr, floatcomplex *work, integer 
	*lwork, floatreal *rwork, integer *info);

/* Subroutine */ int zgehd2_(integer *n, integer *ilo, integer *ihi, 
	floatcomplex *a, integer *lda, floatcomplex *tau, floatcomplex *
	work, integer *info);
...
/* Subroutine */ int zgelq2_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *info);

/* Subroutine */ int zgelqf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zgels_(char *trans, integer *m, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int zgelsd_(integer *m, integer *n, integer *nrhs, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatreal *s, floatreal *rcond, integer *rank, floatcomplex *work, 
	integer *lwork, floatreal *rwork, integer *iwork, integer *info);
...
/* Subroutine */ int zgelsx_(integer *m, integer *n, integer *nrhs, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	integer *jpvt, floatreal *rcond, integer *rank, floatcomplex *work, 
...
/* Subroutine */ int zgeql2_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *info);

/* Subroutine */ int zgeqlf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zgeqp3_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, integer *jpvt, floatcomplex *tau, floatcomplex *work, 
	integer *lwork, floatreal *rwork, integer *info);

/* Subroutine */ int zgeqpf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, integer *jpvt, floatcomplex *tau, floatcomplex *work, 
	floatreal *rwork, integer *info);

/* Subroutine */ int zgeqr2_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *info);

/* Subroutine */ int zgeqrf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zgerfs_(char *trans, integer *n, integer *nrhs, 
	floatcomplex *a, integer *lda, floatcomplex *af, integer *ldaf, 
	integer *ipiv, floatcomplex *b, integer *ldb, floatcomplex *x, 
	integer *ldx, floatreal *ferr, floatreal *berr, floatcomplex *work, 
	 floatreal *rwork, integer *info);

/* Subroutine */ int zgerfsx_(char *trans, char *equed, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, integer *ipiv, floatreal *r__, floatreal *c__, floatcomplex *
	b, integer *ldb, floatcomplex *x, integer *ldx, floatreal *rcond, 
	floatreal *berr, integer *n_err_bnds__, floatreal *err_bnds_norm__, 
	floatreal *err_bnds_comp__, integer *nparams, floatreal *params, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zgerq2_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *info);

/* Subroutine */ int zgerqf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zgesc2_(integer *n, floatcomplex *a, integer *lda, 
	floatcomplex *rhs, integer *ipiv, integer *jpiv, floatreal *scale);

/* Subroutine */ int zgesdd_(char *jobz, integer *m, integer *n, 
	floatcomplex *a, integer *lda, floatreal *s, floatcomplex *u, 
	integer *ldu, floatcomplex *vt, integer *ldvt, floatcomplex *work, 
	integer *lwork, floatreal *rwork, integer *iwork, integer *info);

/* Subroutine */ int zgesv_(integer *n, integer *nrhs, floatcomplex *a, 
	integer *lda, integer *ipiv, floatcomplex *b, integer *ldb, integer *
	info);
...
/* Subroutine */ int zgesvx_(char *fact, char *trans, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, integer *ipiv, char *equed, floatreal *r__, floatreal *c__, 
	floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	floatreal *rcond, floatreal *ferr, floatreal *berr, floatcomplex *
	work, floatreal *rwork, integer *info);
...
/* Subroutine */ int zgesvxx_(char *fact, char *trans, integer *n, integer *
	...
	ldaf, integer *ipiv, char *equed, floatreal *r__, floatreal *c__, 
	floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	floatreal *rcond, floatreal *rpvgrw, floatreal *berr, integer *
	n_err_bnds__, floatreal *err_bnds_norm__, floatreal *
	err_bnds_comp__, integer *nparams, floatreal *params, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zgetc2_(integer *n, floatcomplex *a, integer *lda, 
	integer *ipiv, integer *jpiv, integer *info);

/* Subroutine */ int zgetf2_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, integer *info);

/* Subroutine */ int zgetrf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, integer *info);

/* Subroutine */ int zgetri_(integer *n, floatcomplex *a, integer *lda, 
	integer *ipiv, floatcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int zgetrs_(char *trans, integer *n, integer *nrhs, 
	floatcomplex *a, integer *lda, integer *ipiv, floatcomplex *b, 
	integer *ldb, integer *info);

/* Subroutine */ int zggbak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, floatreal *lscale, floatreal *rscale, integer *m, 
	floatcomplex *v, integer *ldv, integer *info);

/* Subroutine */ int zggbal_(char *job, integer *n, floatcomplex *a, integer 
	*lda, floatcomplex *b, integer *ldb, integer *ilo, integer *ihi, 
	floatreal *lscale, floatreal *rscale, floatreal *work, integer *
	info);

/* Subroutine */ int zgges_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, integer *n, floatcomplex *a, integer *lda, floatcomplex *b, 
	integer *ldb, integer *sdim, floatcomplex *alpha, floatcomplex *
	beta, floatcomplex *vsl, integer *ldvsl, floatcomplex *vsr, integer 
	*ldvsr, floatcomplex *work, integer *lwork, floatreal *rwork, 
	logical *bwork, integer *info);

/* Subroutine */ int zggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, char *sense, integer *n, floatcomplex *a, integer *lda, 
	floatcomplex *b, integer *ldb, integer *sdim, floatcomplex *alpha, 
	floatcomplex *beta, floatcomplex *vsl, integer *ldvsl, 
	floatcomplex *vsr, integer *ldvsr, floatreal *rconde, floatreal *
	rcondv, floatcomplex *work, integer *lwork, floatreal *rwork, 
...
/* Subroutine */ int zggevx_(char *balanc, char *jobvl, char *jobvr, char *
	sense, integer *n, floatcomplex *a, integer *lda, floatcomplex *b, 
	integer *ldb, floatcomplex *alpha, floatcomplex *beta, 
	floatcomplex *vl, integer *ldvl, floatcomplex *vr, integer *ldvr, 
	integer *ilo, integer *ihi, floatreal *lscale, floatreal *rscale, 
	floatreal *abnrm, floatreal *bbnrm, floatreal *rconde, floatreal *
	rcondv, floatcomplex *work, integer *lwork, floatreal *rwork, 
...
/* Subroutine */ int zggglm_(integer *n, integer *m, integer *p, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *d__, floatcomplex *x, floatcomplex *y, floatcomplex 
	*work, integer *lwork, integer *info);

/* Subroutine */ int zgghrd_(char *compq, char *compz, integer *n, integer *
	ilo, integer *ihi, floatcomplex *a, integer *lda, floatcomplex *b, 
	integer *ldb, floatcomplex *q, integer *ldq, floatcomplex *z__, 
	integer *ldz, integer *info);

/* Subroutine */ int zgglse_(integer *m, integer *n, integer *p, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *c__, floatcomplex *d__, floatcomplex *x, 
	floatcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int zggqrf_(integer *n, integer *m, integer *p, 
	floatcomplex *a, integer *lda, floatcomplex *taua, floatcomplex *b, 
	 integer *ldb, floatcomplex *taub, floatcomplex *work, integer *
	lwork, integer *info);
...
/* Subroutine */ int zggsvd_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *n, integer *p, integer *k, integer *l, floatcomplex *a, 
	integer *lda, floatcomplex *b, integer *ldb, floatreal *alpha, 
	floatreal *beta, floatcomplex *u, integer *ldu, floatcomplex *v, 
	integer *ldv, floatcomplex *q, integer *ldq, floatcomplex *work, 
	floatreal *rwork, integer *iwork, integer *info);

/* Subroutine */ int zggsvp_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *p, integer *n, floatcomplex *a, integer *lda, floatcomplex 
	*b, integer *ldb, floatreal *tola, floatreal *tolb, integer *k, 
	integer *l, floatcomplex *u, integer *ldu, floatcomplex *v, integer 
	*ldv, floatcomplex *q, integer *ldq, integer *iwork, floatreal *
	rwork, floatcomplex *tau, floatcomplex *work, integer *info);

/* Subroutine */ int zgtcon_(char *norm, integer *n, floatcomplex *dl, 
	floatcomplex *d__, floatcomplex *du, floatcomplex *du2, integer *
	ipiv, floatreal *anorm, floatreal *rcond, floatcomplex *work, 
	integer *info);

/* Subroutine */ int zgtrfs_(char *trans, integer *n, integer *nrhs, 
	floatcomplex *dl, floatcomplex *d__, floatcomplex *du, 
	floatcomplex *dlf, floatcomplex *df, floatcomplex *duf, 
	floatcomplex *du2, integer *ipiv, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zgtsv_(integer *n, integer *nrhs, floatcomplex *dl, 
	floatcomplex *d__, floatcomplex *du, floatcomplex *b, integer *ldb, 
	 integer *info);

/* Subroutine */ int zgtsvx_(char *fact, char *trans, integer *n, integer *
	nrhs, floatcomplex *dl, floatcomplex *d__, floatcomplex *du, 
	floatcomplex *dlf, floatcomplex *df, floatcomplex *duf, 
	floatcomplex *du2, integer *ipiv, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *rcond, floatreal *ferr, 
	floatreal *berr, floatcomplex *work, floatreal *rwork, integer *
...
/* Subroutine */ int zgttrf_(integer *n, floatcomplex *dl, floatcomplex *
	d__, floatcomplex *du, floatcomplex *du2, integer *ipiv, integer *
	info);
...
/* Subroutine */ int zhbev_(char *jobz, char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, floatreal *w, floatcomplex *z__, 
	integer *ldz, floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zhbevd_(char *jobz, char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, floatreal *w, floatcomplex *z__, 
	integer *ldz, floatcomplex *work, integer *lwork, floatreal *rwork, 
	integer *lrwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int zhbevx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *kd, floatcomplex *ab, integer *ldab, floatcomplex *q, 
	integer *ldq, floatreal *vl, floatreal *vu, integer *il, integer *
	iu, floatreal *abstol, integer *m, floatreal *w, floatcomplex *z__, 
	 integer *ldz, floatcomplex *work, floatreal *rwork, integer *iwork, 
	 integer *ifail, integer *info);

/* Subroutine */ int zhbgst_(char *vect, char *uplo, integer *n, integer *ka, 
	integer *kb, floatcomplex *ab, integer *ldab, floatcomplex *bb, 
	integer *ldbb, floatcomplex *x, integer *ldx, floatcomplex *work, 
	floatreal *rwork, integer *info);

/* Subroutine */ int zhbgv_(char *jobz, char *uplo, integer *n, integer *ka, 
	integer *kb, floatcomplex *ab, integer *ldab, floatcomplex *bb, 
	integer *ldbb, floatreal *w, floatcomplex *z__, integer *ldz, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zhbgvd_(char *jobz, char *uplo, integer *n, integer *ka, 
	integer *kb, floatcomplex *ab, integer *ldab, floatcomplex *bb, 
	integer *ldbb, floatreal *w, floatcomplex *z__, integer *ldz, 
	floatcomplex *work, integer *lwork, floatreal *rwork, integer *
	lrwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int zhbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *ka, integer *kb, floatcomplex *ab, integer *ldab, 
	floatcomplex *bb, integer *ldbb, floatcomplex *q, integer *ldq, 
	floatreal *vl, floatreal *vu, integer *il, integer *iu, floatreal *
	abstol, integer *m, floatreal *w, floatcomplex *z__, integer *ldz, 
	floatcomplex *work, floatreal *rwork, integer *iwork, integer *
	ifail, integer *info);

/* Subroutine */ int zhbtrd_(char *vect, char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, floatreal *d__, floatreal *e, 
	floatcomplex *q, integer *ldq, floatcomplex *work, integer *info);

/* Subroutine */ int zhecon_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, floatreal *anorm, floatreal *rcond, 
	floatcomplex *work, integer *info);

/* Subroutine */ int zheequb_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *s, floatreal *scond, floatreal *amax, 
	floatcomplex *work, integer *info);

/* Subroutine */ int zheev_(char *jobz, char *uplo, integer *n, floatcomplex 
	*a, integer *lda, floatreal *w, floatcomplex *work, integer *lwork, 
	floatreal *rwork, integer *info);

/* Subroutine */ int zheevd_(char *jobz, char *uplo, integer *n, 
	floatcomplex *a, integer *lda, floatreal *w, floatcomplex *work, 
	integer *lwork, floatreal *rwork, integer *lrwork, integer *iwork, 
	integer *liwork, integer *info);

/* Subroutine */ int zheevr_(char *jobz, char *range, char *uplo, integer *n, 
	floatcomplex *a, integer *lda, floatreal *vl, floatreal *vu, 
	integer *il, integer *iu, floatreal *abstol, integer *m, floatreal *
	w, floatcomplex *z__, integer *ldz, integer *isuppz, floatcomplex *
	work, integer *lwork, floatreal *rwork, integer *lrwork, integer *
	iwork, integer *liwork, integer *info);

/* Subroutine */ int zheevx_(char *jobz, char *range, char *uplo, integer *n, 
	floatcomplex *a, integer *lda, floatreal *vl, floatreal *vu, 
	integer *il, integer *iu, floatreal *abstol, integer *m, floatreal *
	w, floatcomplex *z__, integer *ldz, floatcomplex *work, integer *
	lwork, floatreal *rwork, integer *iwork, integer *ifail, integer *
	info);
...
/* Subroutine */ int zhegv_(integer *itype, char *jobz, char *uplo, integer *
	n, floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatreal *w, floatcomplex *work, integer *lwork, floatreal *rwork, 
	 integer *info);
...
/* Subroutine */ int zhegvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, floatcomplex *a, integer *lda, floatcomplex *b, 
	integer *ldb, floatreal *vl, floatreal *vu, integer *il, integer *
	iu, floatreal *abstol, integer *m, floatreal *w, floatcomplex *z__, 
	 integer *ldz, floatcomplex *work, integer *lwork, floatreal *rwork, 
	 integer *iwork, integer *ifail, integer *info);
...
/* Subroutine */ int zherfsx_(char *uplo, char *equed, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, integer *ipiv, floatreal *s, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *rcond, floatreal *berr, 
	integer *n_err_bnds__, floatreal *err_bnds_norm__, floatreal *
	err_bnds_comp__, integer *nparams, floatreal *params, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zhesv_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *a, integer *lda, integer *ipiv, floatcomplex *b, 
	integer *ldb, floatcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int zhesvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, integer *ipiv, floatcomplex *b, integer *ldb, floatcomplex *x, 
	 integer *ldx, floatreal *rcond, floatreal *ferr, floatreal *berr, 
...
/* Subroutine */ int zhesvxx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, integer *ipiv, char *equed, floatreal *s, floatcomplex *b, 
	integer *ldb, floatcomplex *x, integer *ldx, floatreal *rcond, 
	floatreal *rpvgrw, floatreal *berr, integer *n_err_bnds__, 
	floatreal *err_bnds_norm__, floatreal *err_bnds_comp__, integer *
	nparams, floatreal *params, floatcomplex *work, floatreal *rwork, 
	integer *info);

/* Subroutine */ int zhetd2_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *d__, floatreal *e, floatcomplex *tau, 
	integer *info);

/* Subroutine */ int zhetf2_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, integer *info);

/* Subroutine */ int zhetrd_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *d__, floatreal *e, floatcomplex *tau, 
	floatcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int zhetrf_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, floatcomplex *work, integer *lwork, 
	integer *info);

/* Subroutine */ int zhetri_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, floatcomplex *work, integer *info);
...
/* Subroutine */ int zhfrk_(char *transr, char *uplo, char *trans, integer *n, 
	 integer *k, floatreal *alpha, floatcomplex *a, integer *lda, 
	floatreal *beta, floatcomplex *c__);

/* Subroutine */ int zhgeqz_(char *job, char *compq, char *compz, integer *n, 
	integer *ilo, integer *ihi, floatcomplex *h__, integer *ldh, 
	floatcomplex *t, integer *ldt, floatcomplex *alpha, floatcomplex *
	beta, floatcomplex *q, integer *ldq, floatcomplex *z__, integer *
	ldz, floatcomplex *work, integer *lwork, floatreal *rwork, integer *
	info);

/* Subroutine */ int zhpcon_(char *uplo, integer *n, floatcomplex *ap, 
	integer *ipiv, floatreal *anorm, floatreal *rcond, floatcomplex *
	work, integer *info);

/* Subroutine */ int zhpev_(char *jobz, char *uplo, integer *n, floatcomplex 
	*ap, floatreal *w, floatcomplex *z__, integer *ldz, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zhpevd_(char *jobz, char *uplo, integer *n, 
	floatcomplex *ap, floatreal *w, floatcomplex *z__, integer *ldz, 
	floatcomplex *work, integer *lwork, floatreal *rwork, integer *
	lrwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int zhpevx_(char *jobz, char *range, char *uplo, integer *n, 
	floatcomplex *ap, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatcomplex *z__, integer *ldz, floatcomplex *work, floatreal *
	rwork, integer *iwork, integer *ifail, integer *info);

/* Subroutine */ int zhpgst_(integer *itype, char *uplo, integer *n, 
	floatcomplex *ap, floatcomplex *bp, integer *info);

/* Subroutine */ int zhpgv_(integer *itype, char *jobz, char *uplo, integer *
	n, floatcomplex *ap, floatcomplex *bp, floatreal *w, floatcomplex 
	*z__, integer *ldz, floatcomplex *work, floatreal *rwork, integer *
	info);

/* Subroutine */ int zhpgvd_(integer *itype, char *jobz, char *uplo, integer *
	n, floatcomplex *ap, floatcomplex *bp, floatreal *w, floatcomplex 
	*z__, integer *ldz, floatcomplex *work, integer *lwork, floatreal *
	rwork, integer *lrwork, integer *iwork, integer *liwork, integer *
	info);

/* Subroutine */ int zhpgvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, floatcomplex *ap, floatcomplex *bp, floatreal *
	vl, floatreal *vu, integer *il, integer *iu, floatreal *abstol, 
	integer *m, floatreal *w, floatcomplex *z__, integer *ldz, 
	floatcomplex *work, floatreal *rwork, integer *iwork, integer *
	ifail, integer *info);

/* Subroutine */ int zhprfs_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *ap, floatcomplex *afp, integer *ipiv, floatcomplex *
	b, integer *ldb, floatcomplex *x, integer *ldx, floatreal *ferr, 
	floatreal *berr, floatcomplex *work, floatreal *rwork, integer *
	info);

/* Subroutine */ int zhpsv_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *ap, integer *ipiv, floatcomplex *b, integer *ldb, 
	integer *info);

/* Subroutine */ int zhpsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatcomplex *ap, floatcomplex *afp, integer *ipiv, 
	floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	floatreal *rcond, floatreal *ferr, floatreal *berr, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zhptrd_(char *uplo, integer *n, floatcomplex *ap, 
	floatreal *d__, floatreal *e, floatcomplex *tau, integer *info);

/* Subroutine */ int zhptrf_(char *uplo, integer *n, floatcomplex *ap, 
	integer *ipiv, integer *info);

/* Subroutine */ int zhptri_(char *uplo, integer *n, floatcomplex *ap, 
...
/* Subroutine */ int zhsein_(char *side, char *eigsrc, char *initv, logical *
	select, integer *n, floatcomplex *h__, integer *ldh, floatcomplex *
	w, floatcomplex *vl, integer *ldvl, floatcomplex *vr, integer *ldvr, 
	 integer *mm, integer *m, floatcomplex *work, floatreal *rwork, 
	integer *ifaill, integer *ifailr, integer *info);

/* Subroutine */ int zhseqr_(char *job, char *compz, integer *n, integer *ilo, 
	 integer *ihi, floatcomplex *h__, integer *ldh, floatcomplex *w, 
	floatcomplex *z__, integer *ldz, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zla_gbamv__(integer *trans, integer *m, integer *n, 
	integer *kl, integer *ku, floatreal *alpha, floatcomplex *ab, 
	integer *ldab, floatcomplex *x, integer *incx, floatreal *beta, 
	floatreal *y, integer *incy);

floatreal zla_gbrcond_c__(char *trans, integer *n, integer *kl, integer *ku, 
	floatcomplex *ab, integer *ldab, floatcomplex *afb, integer *ldafb, 
	integer *ipiv, floatreal *c__, logical *capply, integer *info, 
	floatcomplex *work, floatreal *rwork, ftnlen trans_len);

floatreal zla_gbrcond_x__(char *trans, integer *n, integer *kl, integer *ku, 
	floatcomplex *ab, integer *ldab, floatcomplex *afb, integer *ldafb, 
	integer *ipiv, floatcomplex *x, integer *info, floatcomplex *work, 
	floatreal *rwork, ftnlen trans_len);

/* Subroutine */ int zla_gbrfsx_extended__(integer *prec_type__, integer *
	trans_type__, integer *n, integer *kl, integer *ku, integer *nrhs, 
	floatcomplex *ab, integer *ldab, floatcomplex *afb, integer *ldafb, 
	integer *ipiv, logical *colequ, floatreal *c__, floatcomplex *b, 
	integer *ldb, floatcomplex *y, integer *ldy, floatreal *berr_out__, 
	integer *n_norms__, floatreal *errs_n__, floatreal *errs_c__, 
	floatcomplex *res, floatreal *ayb, floatcomplex *dy, floatcomplex 
	*y_tail__, floatreal *rcond, integer *ithresh, floatreal *rthresh, 
	floatreal *dz_ub__, logical *ignore_cwise__, integer *info);

floatreal zla_gbrpvgrw__(integer *n, integer *kl, integer *ku, integer *
	ncols, floatcomplex *ab, integer *ldab, floatcomplex *afb, integer *
	ldafb);

/* Subroutine */ int zla_geamv__(integer *trans, integer *m, integer *n, 
	floatreal *alpha, floatcomplex *a, integer *lda, floatcomplex *x, 
	integer *incx, floatreal *beta, floatreal *y, integer *incy);

floatreal zla_gercond_c__(char *trans, integer *n, floatcomplex *a, integer 
	*lda, floatcomplex *af, integer *ldaf, integer *ipiv, floatreal *
	c__, logical *capply, integer *info, floatcomplex *work, floatreal *
	rwork, ftnlen trans_len);

floatreal zla_gercond_x__(char *trans, integer *n, floatcomplex *a, integer 
	*lda, floatcomplex *af, integer *ldaf, integer *ipiv, floatcomplex *
	x, integer *info, floatcomplex *work, floatreal *rwork, ftnlen 
	trans_len);

/* Subroutine */ int zla_gerfsx_extended__(integer *prec_type__, integer *
	trans_type__, integer *n, integer *nrhs, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, integer *ipiv, logical *colequ,
	 floatreal *c__, floatcomplex *b, integer *ldb, floatcomplex *y, 
	integer *ldy, floatreal *berr_out__, integer *n_norms__, floatreal *
	errs_n__, floatreal *errs_c__, floatcomplex *res, floatreal *ayb, 
	floatcomplex *dy, floatcomplex *y_tail__, floatreal *rcond, 
	integer *ithresh, floatreal *rthresh, floatreal *dz_ub__, logical *
	ignore_cwise__, integer *info);

/* Subroutine */ int zla_heamv__(integer *uplo, integer *n, floatreal *alpha,
	 floatcomplex *a, integer *lda, floatcomplex *x, integer *incx, 
	floatreal *beta, floatreal *y, integer *incy);

floatreal zla_hercond_c__(char *uplo, integer *n, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, integer *ipiv, floatreal *c__,
	 logical *capply, integer *info, floatcomplex *work, floatreal *
	rwork, ftnlen uplo_len);

floatreal zla_hercond_x__(char *uplo, integer *n, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, integer *ipiv, floatcomplex *
	x, integer *info, floatcomplex *work, floatreal *rwork, ftnlen 
	uplo_len);

/* Subroutine */ int zla_herfsx_extended__(integer *prec_type__, char *uplo, 
	integer *n, integer *nrhs, floatcomplex *a, integer *lda, 
	floatcomplex *af, integer *ldaf, integer *ipiv, logical *colequ, 
	floatreal *c__, floatcomplex *b, integer *ldb, floatcomplex *y, 
	integer *ldy, floatreal *berr_out__, integer *n_norms__, floatreal *
	errs_n__, floatreal *errs_c__, floatcomplex *res, floatreal *ayb, 
	floatcomplex *dy, floatcomplex *y_tail__, floatreal *rcond, 
...
floatreal zla_herpvgrw__(char *uplo, integer *n, integer *info, 
	floatcomplex *a, integer *lda, floatcomplex *af, integer *ldaf, 
	integer *ipiv, floatreal *work, ftnlen uplo_len);

/* Subroutine */ int zla_lin_berr__(integer *n, integer *nz, integer *nrhs, 
	floatcomplex *res, floatreal *ayb, floatreal *berr);

floatreal zla_porcond_c__(char *uplo, integer *n, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, floatreal *c__, logical *
	capply, integer *info, floatcomplex *work, floatreal *rwork, ftnlen 
	uplo_len);

floatreal zla_porcond_x__(char *uplo, integer *n, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, floatcomplex *x, integer *
	info, floatcomplex *work, floatreal *rwork, ftnlen uplo_len);

/* Subroutine */ int zla_porfsx_extended__(integer *prec_type__, char *uplo, 
	integer *n, integer *nrhs, floatcomplex *a, integer *lda, 
	floatcomplex *af, integer *ldaf, logical *colequ, floatreal *c__, 
	floatcomplex *b, integer *ldb, floatcomplex *y, integer *ldy, 
	floatreal *berr_out__, integer *n_norms__, floatreal *errs_n__, 
	floatreal *errs_c__, floatcomplex *res, floatreal *ayb, 
	floatcomplex *dy, floatcomplex *y_tail__, floatreal *rcond, 
	integer *ithresh, floatreal *rthresh, floatreal *dz_ub__, logical *
	ignore_cwise__, integer *info, ftnlen uplo_len);

floatreal zla_porpvgrw__(char *uplo, integer *ncols, floatcomplex *a, 
	integer *lda, floatcomplex *af, integer *ldaf, floatreal *work, 
	ftnlen uplo_len);

floatreal zla_rpvgrw__(integer *n, integer *ncols, floatcomplex *a, integer 
	*lda, floatcomplex *af, integer *ldaf);

/* Subroutine */ int zla_syamv__(integer *uplo, integer *n, floatreal *alpha,
	 floatcomplex *a, integer *lda, floatcomplex *x, integer *incx, 
	floatreal *beta, floatreal *y, integer *incy);

floatreal zla_syrcond_c__(char *uplo, integer *n, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, integer *ipiv, floatreal *c__,
	 logical *capply, integer *info, floatcomplex *work, floatreal *
	rwork, ftnlen uplo_len);

floatreal zla_syrcond_x__(char *uplo, integer *n, floatcomplex *a, integer *
	lda, floatcomplex *af, integer *ldaf, integer *ipiv, floatcomplex *
	x, integer *info, floatcomplex *work, floatreal *rwork, ftnlen 
	uplo_len);
...
floatreal zla_syrpvgrw__(char *uplo, integer *n, integer *info, 
	floatcomplex *a, integer *lda, floatcomplex *af, integer *ldaf, 
	integer *ipiv, floatreal *work, ftnlen uplo_len);

/* Subroutine */ int zla_wwaddw__(integer *n, floatcomplex *x, floatcomplex 
	*y, floatcomplex *w);

/* Subroutine */ int zlabrd_(integer *m, integer *n, integer *nb, 
	floatcomplex *a, integer *lda, floatreal *d__, floatreal *e, 
	floatcomplex *tauq, floatcomplex *taup, floatcomplex *x, integer *
	ldx, floatcomplex *y, integer *ldy);

/* Subroutine */ int zlacgv_(integer *n, floatcomplex *x, integer *incx);

/* Subroutine */ int zlacn2_(integer *n, floatcomplex *v, floatcomplex *x, 
	floatreal *est, integer *kase, integer *isave);

/* Subroutine */ int zlacon_(integer *n, floatcomplex *v, floatcomplex *x, 
	floatreal *est, integer *kase);

/* Subroutine */ int zlacp2_(char *uplo, integer *m, integer *n, floatreal *
	a, integer *lda, floatcomplex *b, integer *ldb);

/* Subroutine */ int zlacpy_(char *uplo, integer *m, integer *n, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb);

/* Subroutine */ int zlacrm_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *b, integer *ldb, floatcomplex *c__, 
	integer *ldc, floatreal *rwork);

/* Subroutine */ int zlacrt_(integer *n, floatcomplex *cx, integer *incx, 
	floatcomplex *cy, integer *incy, floatcomplex *c__, floatcomplex *
	s);

/* float Complex */ VOID zladiv_(floatcomplex * ret_val, floatcomplex *x, 
	floatcomplex *y);

/* Subroutine */ int zlaed0_(integer *qsiz, integer *n, floatreal *d__, 
	floatreal *e, floatcomplex *q, integer *ldq, floatcomplex *qstore, 
	integer *ldqs, floatreal *rwork, integer *iwork, integer *info);

/* Subroutine */ int zlaed7_(integer *n, integer *cutpnt, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, floatreal *d__, 
	floatcomplex *q, integer *ldq, floatreal *rho, integer *indxq, 
	floatreal *qstore, integer *qptr, integer *prmptr, integer *perm, 
	integer *givptr, integer *givcol, floatreal *givnum, floatcomplex *
	work, floatreal *rwork, integer *iwork, integer *info);

/* Subroutine */ int zlaed8_(integer *k, integer *n, integer *qsiz, 
	floatcomplex *q, integer *ldq, floatreal *d__, floatreal *rho, 
	integer *cutpnt, floatreal *z__, floatreal *dlamda, floatcomplex *
	q2, integer *ldq2, floatreal *w, integer *indxp, integer *indx, 
	integer *indxq, integer *perm, integer *givptr, integer *givcol, 
	floatreal *givnum, integer *info);

/* Subroutine */ int zlaein_(logical *rightv, logical *noinit, integer *n, 
	floatcomplex *h__, integer *ldh, floatcomplex *w, floatcomplex *v, 
	floatcomplex *b, integer *ldb, floatreal *rwork, floatreal *eps3, 
	floatreal *smlnum, integer *info);

/* Subroutine */ int zlaesy_(floatcomplex *a, floatcomplex *b, 
	floatcomplex *c__, floatcomplex *rt1, floatcomplex *rt2, 
	floatcomplex *evscal, floatcomplex *cs1, floatcomplex *sn1);

/* Subroutine */ int zlaev2_(floatcomplex *a, floatcomplex *b, 
	floatcomplex *c__, floatreal *rt1, floatreal *rt2, floatreal *cs1, 
	 floatcomplex *sn1);

/* Subroutine */ int zlag2c_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, complex *sa, integer *ldsa, integer *info);

/* Subroutine */ int zlags2_(logical *upper, floatreal *a1, floatcomplex *
	a2, floatreal *a3, floatreal *b1, floatcomplex *b2, floatreal *b3, 
	 floatreal *csu, floatcomplex *snu, floatreal *csv, floatcomplex *
	snv, floatreal *csq, floatcomplex *snq);

/* Subroutine */ int zlagtm_(char *trans, integer *n, integer *nrhs, 
	floatreal *alpha, floatcomplex *dl, floatcomplex *d__, 
	floatcomplex *du, floatcomplex *x, integer *ldx, floatreal *beta, 
	floatcomplex *b, integer *ldb);

/* Subroutine */ int zlahef_(char *uplo, integer *n, integer *nb, integer *kb, 
	 floatcomplex *a, integer *lda, integer *ipiv, floatcomplex *w, 
	integer *ldw, integer *info);

/* Subroutine */ int zlahqr_(logical *wantt, logical *wantz, integer *n, 
	integer *ilo, integer *ihi, floatcomplex *h__, integer *ldh, 
	floatcomplex *w, integer *iloz, integer *ihiz, floatcomplex *z__, 
	integer *ldz, integer *info);

/* Subroutine */ int zlahr2_(integer *n, integer *k, integer *nb, 
	floatcomplex *a, integer *lda, floatcomplex *tau, floatcomplex *t, 
	integer *ldt, floatcomplex *y, integer *ldy);

/* Subroutine */ int zlahrd_(integer *n, integer *k, integer *nb, 
	floatcomplex *a, integer *lda, floatcomplex *tau, floatcomplex *t, 
	integer *ldt, floatcomplex *y, integer *ldy);

/* Subroutine */ int zlaic1_(integer *job, integer *j, floatcomplex *x, 
	floatreal *sest, floatcomplex *w, floatcomplex *gamma, floatreal *
	sestpr, floatcomplex *s, floatcomplex *c__);

/* Subroutine */ int zlals0_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, integer *nrhs, floatcomplex *b, integer *ldb, 
	floatcomplex *bx, integer *ldbx, integer *perm, integer *givptr, 
	integer *givcol, integer *ldgcol, floatreal *givnum, integer *ldgnum, 
	 floatreal *poles, floatreal *difl, floatreal *difr, floatreal *
	z__, integer *k, floatreal *c__, floatreal *s, floatreal *rwork, 
	integer *info);

/* Subroutine */ int zlalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, floatcomplex *b, integer *ldb, floatcomplex *bx, 
	integer *ldbx, floatreal *u, integer *ldu, floatreal *vt, integer *
	k, floatreal *difl, floatreal *difr, floatreal *z__, floatreal *
	poles, integer *givptr, integer *givcol, integer *ldgcol, integer *
	perm, floatreal *givnum, floatreal *c__, floatreal *s, floatreal *
	rwork, integer *iwork, integer *info);

/* Subroutine */ int zlalsd_(char *uplo, integer *smlsiz, integer *n, integer 
	*nrhs, floatreal *d__, floatreal *e, floatcomplex *b, integer *ldb, 
	 floatreal *rcond, integer *rank, floatcomplex *work, floatreal *
	rwork, integer *iwork, integer *info);

floatreal zlangb_(char *norm, integer *n, integer *kl, integer *ku, 
	floatcomplex *ab, integer *ldab, floatreal *work);

floatreal zlange_(char *norm, integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *work);

floatreal zlangt_(char *norm, integer *n, floatcomplex *dl, floatcomplex *
	d__, floatcomplex *du);

floatreal zlanhb_(char *norm, char *uplo, integer *n, integer *k, 
	floatcomplex *ab, integer *ldab, floatreal *work);

floatreal zlanhe_(char *norm, char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *work);

floatreal zlanhf_(char *norm, char *transr, char *uplo, integer *n, 
	floatcomplex *a, floatreal *work);

floatreal zlanhp_(char *norm, char *uplo, integer *n, floatcomplex *ap, 
	floatreal *work);

floatreal zlanhs_(char *norm, integer *n, floatcomplex *a, integer *lda, 
	floatreal *work);

floatreal zlanht_(char *norm, integer *n, floatreal *d__, floatcomplex *e);

floatreal zlansb_(char *norm, char *uplo, integer *n, integer *k, 
	floatcomplex *ab, integer *ldab, floatreal *work);

floatreal zlansp_(char *norm, char *uplo, integer *n, floatcomplex *ap, 
	floatreal *work);

floatreal zlansy_(char *norm, char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *work);

floatreal zlantb_(char *norm, char *uplo, char *diag, integer *n, integer *k, 
	 floatcomplex *ab, integer *ldab, floatreal *work);

floatreal zlantp_(char *norm, char *uplo, char *diag, integer *n, 
	floatcomplex *ap, floatreal *work);

floatreal zlantr_(char *norm, char *uplo, char *diag, integer *m, integer *n, 
	 floatcomplex *a, integer *lda, floatreal *work);

/* Subroutine */ int zlapll_(integer *n, floatcomplex *x, integer *incx, 
	floatcomplex *y, integer *incy, floatreal *ssmin);

/* Subroutine */ int zlapmt_(logical *forwrd, integer *m, integer *n, 
	floatcomplex *x, integer *ldx, integer *k);

/* Subroutine */ int zlaqgb_(integer *m, integer *n, integer *kl, integer *ku, 
	 floatcomplex *ab, integer *ldab, floatreal *r__, floatreal *c__, 
	floatreal *rowcnd, floatreal *colcnd, floatreal *amax, char *equed);

/* Subroutine */ int zlaqge_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatreal *r__, floatreal *c__, floatreal *rowcnd, 
	floatreal *colcnd, floatreal *amax, char *equed);

/* Subroutine */ int zlaqhb_(char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, floatreal *s, floatreal *scond, 
	floatreal *amax, char *equed);

/* Subroutine */ int zlaqhe_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *s, floatreal *scond, floatreal *amax, 
	char *equed);

/* Subroutine */ int zlaqhp_(char *uplo, integer *n, floatcomplex *ap, 
	floatreal *s, floatreal *scond, floatreal *amax, char *equed);

/* Subroutine */ int zlaqp2_(integer *m, integer *n, integer *offset, 
	floatcomplex *a, integer *lda, integer *jpvt, floatcomplex *tau, 
	floatreal *vn1, floatreal *vn2, floatcomplex *work);

/* Subroutine */ int zlaqps_(integer *m, integer *n, integer *offset, integer 
	*nb, integer *kb, floatcomplex *a, integer *lda, integer *jpvt, 
	floatcomplex *tau, floatreal *vn1, floatreal *vn2, floatcomplex *
	auxv, floatcomplex *f, integer *ldf);
...
/* Subroutine */ int zlaqr1_(integer *n, floatcomplex *h__, integer *ldh, 
	floatcomplex *s1, floatcomplex *s2, floatcomplex *v);

/* Subroutine */ int zlaqr2_(logical *wantt, logical *wantz, integer *n, 
	integer *ktop, integer *kbot, integer *nw, floatcomplex *h__, 
	integer *ldh, integer *iloz, integer *ihiz, floatcomplex *z__, 
	integer *ldz, integer *ns, integer *nd, floatcomplex *sh, 
	floatcomplex *v, integer *ldv, integer *nh, floatcomplex *t, 
	integer *ldt, integer *nv, floatcomplex *wv, integer *ldwv, 
...
/* Subroutine */ int zlaqr5_(logical *wantt, logical *wantz, integer *kacc22, 
	...
	floatcomplex *s, floatcomplex *h__, integer *ldh, integer *iloz, 
	integer *ihiz, floatcomplex *z__, integer *ldz, floatcomplex *v, 
	integer *ldv, floatcomplex *u, integer *ldu, integer *nv, 
	floatcomplex *wv, integer *ldwv, integer *nh, floatcomplex *wh, 
	integer *ldwh);
...
/* Subroutine */ int zlaqsp_(char *uplo, integer *n, floatcomplex *ap, 
	floatreal *s, floatreal *scond, floatreal *amax, char *equed);

/* Subroutine */ int zlaqsy_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *s, floatreal *scond, floatreal *amax, 
	char *equed);

/* Subroutine */ int zlar1v_(integer *n, integer *b1, integer *bn, floatreal 
	*lambda, floatreal *d__, floatreal *l, floatreal *ld, floatreal *
	lld, floatreal *pivmin, floatreal *gaptol, floatcomplex *z__, 
	logical *wantnc, integer *negcnt, floatreal *ztz, floatreal *mingma, 
	 integer *r__, integer *isuppz, floatreal *nrminv, floatreal *resid, 
	 floatreal *rqcorr, floatreal *work);

/* Subroutine */ int zlar2v_(integer *n, floatcomplex *x, floatcomplex *y, 
	floatcomplex *z__, integer *incx, floatreal *c__, floatcomplex *s, 
	integer *incc);

/* Subroutine */ int zlarcm_(integer *m, integer *n, floatreal *a, integer *
	lda, floatcomplex *b, integer *ldb, floatcomplex *c__, integer *ldc, 
	 floatreal *rwork);

/* Subroutine */ int zlarf_(char *side, integer *m, integer *n, floatcomplex 
	*v, integer *incv, floatcomplex *tau, floatcomplex *c__, integer *
	ldc, floatcomplex *work);

/* Subroutine */ int zlarfb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, floatcomplex *v, integer 
	*ldv, floatcomplex *t, integer *ldt, floatcomplex *c__, integer *
	ldc, floatcomplex *work, integer *ldwork);

/* Subroutine */ int zlarfg_(integer *n, floatcomplex *alpha, floatcomplex *
	x, integer *incx, floatcomplex *tau);

/* Subroutine */ int zlarfp_(integer *n, floatcomplex *alpha, floatcomplex *
	x, integer *incx, floatcomplex *tau);

/* Subroutine */ int zlarft_(char *direct, char *storev, integer *n, integer *
	k, floatcomplex *v, integer *ldv, floatcomplex *tau, floatcomplex *
	t, integer *ldt);

/* Subroutine */ int zlarfx_(char *side, integer *m, integer *n, 
	floatcomplex *v, floatcomplex *tau, floatcomplex *c__, integer *
	ldc, floatcomplex *work);

/* Subroutine */ int zlargv_(integer *n, floatcomplex *x, integer *incx, 
	floatcomplex *y, integer *incy, floatreal *c__, integer *incc);

/* Subroutine */ int zlarnv_(integer *idist, integer *iseed, integer *n, 
	floatcomplex *x);

/* Subroutine */ int zlarrv_(integer *n, floatreal *vl, floatreal *vu, 
	floatreal *d__, floatreal *l, floatreal *pivmin, integer *isplit, 
	integer *m, integer *dol, integer *dou, floatreal *minrgp, 
	floatreal *rtol1, floatreal *rtol2, floatreal *w, floatreal *werr, 
	 floatreal *wgap, integer *iblock, integer *indexw, floatreal *gers, 
	 floatcomplex *z__, integer *ldz, integer *isuppz, floatreal *work, 
	integer *iwork, integer *info);

/* Subroutine */ int zlarscl2_(integer *m, integer *n, floatreal *d__, 
	floatcomplex *x, integer *ldx);

/* Subroutine */ int zlartg_(floatcomplex *f, floatcomplex *g, floatreal *
	cs, floatcomplex *sn, floatcomplex *r__);

/* Subroutine */ int zlartv_(integer *n, floatcomplex *x, integer *incx, 
	floatcomplex *y, integer *incy, floatreal *c__, floatcomplex *s, 
	integer *incc);

/* Subroutine */ int zlarz_(char *side, integer *m, integer *n, integer *l, 
	floatcomplex *v, integer *incv, floatcomplex *tau, floatcomplex *
	c__, integer *ldc, floatcomplex *work);

/* Subroutine */ int zlarzb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, integer *l, floatcomplex 
	*v, integer *ldv, floatcomplex *t, integer *ldt, floatcomplex *c__, 
	integer *ldc, floatcomplex *work, integer *ldwork);
...
/* Subroutine */ int zlascl_(char *type__, integer *kl, integer *ku, 
	floatreal *cfrom, floatreal *cto, integer *m, integer *n, 
	floatcomplex *a, integer *lda, integer *info);

/* Subroutine */ int zlascl2_(integer *m, integer *n, floatreal *d__, 
	floatcomplex *x, integer *ldx);

/* Subroutine */ int zlaset_(char *uplo, integer *m, integer *n, 
	floatcomplex *alpha, floatcomplex *beta, floatcomplex *a, integer *
	lda);

/* Subroutine */ int zlasr_(char *side, char *pivot, char *direct, integer *m, 
	 integer *n, floatreal *c__, floatreal *s, floatcomplex *a, 
	integer *lda);

/* Subroutine */ int zlassq_(integer *n, floatcomplex *x, integer *incx, 
	floatreal *scale, floatreal *sumsq);

/* Subroutine */ int zlaswp_(integer *n, floatcomplex *a, integer *lda, 
...
/* Subroutine */ int zlat2c_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, complex *sa, integer *ldsa, integer *info);

/* Subroutine */ int zlatbs_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, integer *kd, floatcomplex *ab, integer *ldab, 
	floatcomplex *x, floatreal *scale, floatreal *cnorm, integer *info);

/* Subroutine */ int zlatdf_(integer *ijob, integer *n, floatcomplex *z__, 
	integer *ldz, floatcomplex *rhs, floatreal *rdsum, floatreal *
	rdscal, integer *ipiv, integer *jpiv);

/* Subroutine */ int zlatps_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, floatcomplex *ap, floatcomplex *x, floatreal *
	scale, floatreal *cnorm, integer *info);

/* Subroutine */ int zlatrd_(char *uplo, integer *n, integer *nb, 
	floatcomplex *a, integer *lda, floatreal *e, floatcomplex *tau, 
	floatcomplex *w, integer *ldw);

/* Subroutine */ int zlatrs_(char *uplo, char *trans, char *diag, char *
	normin, integer *n, floatcomplex *a, integer *lda, floatcomplex *x, 
	floatreal *scale, floatreal *cnorm, integer *info);
...
/* Subroutine */ int zlatzm_(char *side, integer *m, integer *n, 
	floatcomplex *v, integer *incv, floatcomplex *tau, floatcomplex *
	c1, floatcomplex *c2, integer *ldc, floatcomplex *work);

/* Subroutine */ int zlauu2_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *info);

/* Subroutine */ int zlauum_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *info);

/* Subroutine */ int zpbcon_(char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, floatreal *anorm, floatreal *
	rcond, floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zpbequ_(char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, floatreal *s, floatreal *scond, 
	floatreal *amax, integer *info);

/* Subroutine */ int zpbrfs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, floatcomplex *ab, integer *ldab, floatcomplex *afb, integer *
	ldafb, floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	 floatreal *ferr, floatreal *berr, floatcomplex *work, floatreal *
	rwork, integer *info);

/* Subroutine */ int zpbstf_(char *uplo, integer *n, integer *kd, 
	floatcomplex *ab, integer *ldab, integer *info);

/* Subroutine */ int zpbsv_(char *uplo, integer *n, integer *kd, integer *
	nrhs, floatcomplex *ab, integer *ldab, floatcomplex *b, integer *
	ldb, integer *info);

/* Subroutine */ int zpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
	integer *nrhs, floatcomplex *ab, integer *ldab, floatcomplex *afb, 
	integer *ldafb, char *equed, floatreal *s, floatcomplex *b, integer 
	*ldb, floatcomplex *x, integer *ldx, floatreal *rcond, floatreal *
	ferr, floatreal *berr, floatcomplex *work, floatreal *rwork, 
	integer *info);
...
/* Subroutine */ int zpocon_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *anorm, floatreal *rcond, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zpoequ_(integer *n, floatcomplex *a, integer *lda, 
	floatreal *s, floatreal *scond, floatreal *amax, integer *info);

/* Subroutine */ int zpoequb_(integer *n, floatcomplex *a, integer *lda, 
	floatreal *s, floatreal *scond, floatreal *amax, integer *info);
...
/* Subroutine */ int zporfsx_(char *uplo, char *equed, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, floatreal *s, floatcomplex *b, integer *ldb, floatcomplex *x, 
	 integer *ldx, floatreal *rcond, floatreal *berr, integer *
	n_err_bnds__, floatreal *err_bnds_norm__, floatreal *
	err_bnds_comp__, integer *nparams, floatreal *params, floatcomplex *
	work, floatreal *rwork, integer *info);
...
/* Subroutine */ int zposvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatcomplex *a, integer *lda, floatcomplex *af, integer *
	ldaf, char *equed, floatreal *s, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *rcond, floatreal *ferr, 
	floatreal *berr, floatcomplex *work, floatreal *rwork, integer *
	info);
...
/* Subroutine */ int zpotf2_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *info);

/* Subroutine */ int zpotrf_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *info);

/* Subroutine */ int zpotri_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *info);
...
/* Subroutine */ int zppcon_(char *uplo, integer *n, floatcomplex *ap, 
	floatreal *anorm, floatreal *rcond, floatcomplex *work, floatreal 
	*rwork, integer *info);

/* Subroutine */ int zppequ_(char *uplo, integer *n, floatcomplex *ap, 
	floatreal *s, floatreal *scond, floatreal *amax, integer *info);

/* Subroutine */ int zpprfs_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *ap, floatcomplex *afp, floatcomplex *b, integer *ldb, 
	 floatcomplex *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int zppsv_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *ap, floatcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int zppsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, floatcomplex *ap, floatcomplex *afp, char *equed, floatreal *
	s, floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	floatreal *rcond, floatreal *ferr, floatreal *berr, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int zpptrf_(char *uplo, integer *n, floatcomplex *ap, 
	integer *info);

/* Subroutine */ int zpptri_(char *uplo, integer *n, floatcomplex *ap, 
	integer *info);

/* Subroutine */ int zpptrs_(char *uplo, integer *n, integer *nrhs, 
	floatcomplex *ap, floatcomplex *b, integer *ldb, integer *info);

/* Subroutine */ int zpstf2_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *piv, integer *rank, floatreal *tol, 
	floatreal *work, integer *info);

/* Subroutine */ int zpstrf_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *piv, integer *rank, floatreal *tol, 
	floatreal *work, integer *info);

/* Subroutine */ int zptcon_(integer *n, floatreal *d__, floatcomplex *e, 
	floatreal *anorm, floatreal *rcond, floatreal *rwork, integer *
	info);

/* Subroutine */ int zpteqr_(char *compz, integer *n, floatreal *d__, 
	floatreal *e, floatcomplex *z__, integer *ldz, floatreal *work, 
	integer *info);

/* Subroutine */ int zptrfs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *d__, floatcomplex *e, floatreal *df, floatcomplex *ef, 
	floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	floatreal *ferr, floatreal *berr, floatcomplex *work, floatreal *
	rwork, integer *info);

/* Subroutine */ int zptsv_(integer *n, integer *nrhs, floatreal *d__, 
...
/* Subroutine */ int zpttrf_(integer *n, floatreal *d__, floatcomplex *e, 
	integer *info);

/* Subroutine */ int zpttrs_(char *uplo, integer *n, integer *nrhs, 
	floatreal *d__, floatcomplex *e, floatcomplex *b, integer *ldb, 
	integer *info);

/* Subroutine */ int zptts2_(integer *iuplo, integer *n, integer *nrhs, 
	floatreal *d__, floatcomplex *e, floatcomplex *b, integer *ldb);

/* Subroutine */ int zrot_(integer *n, floatcomplex *cx, integer *incx, 
	floatcomplex *cy, integer *incy, floatreal *c__, floatcomplex *s);

/* Subroutine */ int zspcon_(char *uplo, integer *n, floatcomplex *ap, 
	integer *ipiv, floatreal *anorm, floatreal *rcond, floatcomplex *
	work, integer *info);

/* Subroutine */ int zspmv_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *ap, floatcomplex *x, integer *incx, floatcomplex *
	beta, floatcomplex *y, integer *incy);

/* Subroutine */ int zspr_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *ap);
...
/* Subroutine */ int zsptrf_(char *uplo, integer *n, floatcomplex *ap, 
	integer *ipiv, integer *info);

/* Subroutine */ int zsptri_(char *uplo, integer *n, floatcomplex *ap, 
	integer *ipiv, floatcomplex *work, integer *info);
...
/* Subroutine */ int zstedc_(char *compz, integer *n, floatreal *d__, 
	floatreal *e, floatcomplex *z__, integer *ldz, floatcomplex *work, 
	integer *lwork, floatreal *rwork, integer *lrwork, integer *iwork, 
	integer *liwork, integer *info);

/* Subroutine */ int zstegr_(char *jobz, char *range, integer *n, floatreal *
	d__, floatreal *e, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, floatreal *abstol, integer *m, floatreal *w, 
	floatcomplex *z__, integer *ldz, integer *isuppz, floatreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int zstein_(integer *n, floatreal *d__, floatreal *e, 
	integer *m, floatreal *w, integer *iblock, integer *isplit, 
	floatcomplex *z__, integer *ldz, floatreal *work, integer *iwork, 
	integer *ifail, integer *info);

/* Subroutine */ int zstemr_(char *jobz, char *range, integer *n, floatreal *
	d__, floatreal *e, floatreal *vl, floatreal *vu, integer *il, 
	integer *iu, integer *m, floatreal *w, floatcomplex *z__, integer *
	ldz, integer *nzc, integer *isuppz, logical *tryrac, floatreal *work, 
	 integer *lwork, integer *iwork, integer *liwork, integer *info);

/* Subroutine */ int zsteqr_(char *compz, integer *n, floatreal *d__, 
	floatreal *e, floatcomplex *z__, integer *ldz, floatreal *work, 
	integer *info);

/* Subroutine */ int zsycon_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, floatreal *anorm, floatreal *rcond, 
	floatcomplex *work, integer *info);

/* Subroutine */ int zsyequb_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatreal *s, floatreal *scond, floatreal *amax, 
	floatcomplex *work, integer *info);

/* Subroutine */ int zsymv_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *a, integer *lda, floatcomplex *x, integer *incx, 
	floatcomplex *beta, floatcomplex *y, integer *incy);

/* Subroutine */ int zsyr_(char *uplo, integer *n, floatcomplex *alpha, 
	floatcomplex *x, integer *incx, floatcomplex *a, integer *lda);
...
/* Subroutine */ int zsytf2_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, integer *info);

/* Subroutine */ int zsytrf_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, floatcomplex *work, integer *lwork, 
	integer *info);

/* Subroutine */ int zsytri_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, integer *ipiv, floatcomplex *work, integer *info);
...
/* Subroutine */ int ztbcon_(char *norm, char *uplo, char *diag, integer *n, 
	integer *kd, floatcomplex *ab, integer *ldab, floatreal *rcond, 
	floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int ztbrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *kd, integer *nrhs, floatcomplex *ab, integer *ldab, 
	floatcomplex *b, integer *ldb, floatcomplex *x, integer *ldx, 
	floatreal *ferr, floatreal *berr, floatcomplex *work, floatreal *
	rwork, integer *info);
...
/* Subroutine */ int ztfsm_(char *transr, char *side, char *uplo, char *trans, 
	 char *diag, integer *m, integer *n, floatcomplex *alpha, 
	floatcomplex *a, floatcomplex *b, integer *ldb);

/* Subroutine */ int ztftri_(char *transr, char *uplo, char *diag, integer *n, 
	 floatcomplex *a, integer *info);

/* Subroutine */ int ztfttp_(char *transr, char *uplo, integer *n, 
	floatcomplex *arf, floatcomplex *ap, integer *info);

/* Subroutine */ int ztfttr_(char *transr, char *uplo, integer *n, 
	floatcomplex *arf, floatcomplex *a, integer *lda, integer *info);

/* Subroutine */ int ztgevc_(char *side, char *howmny, logical *select, 
	integer *n, floatcomplex *s, integer *lds, floatcomplex *p, integer 
	*ldp, floatcomplex *vl, integer *ldvl, floatcomplex *vr, integer *
	ldvr, integer *mm, integer *m, floatcomplex *work, floatreal *rwork, 
	 integer *info);

/* Subroutine */ int ztgex2_(logical *wantq, logical *wantz, integer *n, 
	floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *q, integer *ldq, floatcomplex *z__, integer *ldz, 
...
/* Subroutine */ int ztgsen_(integer *ijob, logical *wantq, logical *wantz, 
	logical *select, integer *n, floatcomplex *a, integer *lda, 
	floatcomplex *b, integer *ldb, floatcomplex *alpha, floatcomplex *
	beta, floatcomplex *q, integer *ldq, floatcomplex *z__, integer *
	ldz, integer *m, floatreal *pl, floatreal *pr, floatreal *dif, 
	floatcomplex *work, integer *lwork, integer *iwork, integer *liwork, 
	integer *info);

/* Subroutine */ int ztgsja_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *p, integer *n, integer *k, integer *l, floatcomplex *a, 
	integer *lda, floatcomplex *b, integer *ldb, floatreal *tola, 
	floatreal *tolb, floatreal *alpha, floatreal *beta, floatcomplex *
	u, integer *ldu, floatcomplex *v, integer *ldv, floatcomplex *q, 
	integer *ldq, floatcomplex *work, integer *ncycle, integer *info);

/* Subroutine */ int ztgsna_(char *job, char *howmny, logical *select, 
	integer *n, floatcomplex *a, integer *lda, floatcomplex *b, integer 
	*ldb, floatcomplex *vl, integer *ldvl, floatcomplex *vr, integer *
	ldvr, floatreal *s, floatreal *dif, integer *mm, integer *m, 
	floatcomplex *work, integer *lwork, integer *iwork, integer *info);

/* Subroutine */ int ztgsy2_(char *trans, integer *ijob, integer *m, integer *
	n, floatcomplex *a, integer *lda, floatcomplex *b, integer *ldb, 
	floatcomplex *c__, integer *ldc, floatcomplex *d__, integer *ldd, 
	floatcomplex *e, integer *lde, floatcomplex *f, integer *ldf, 
	floatreal *scale, floatreal *rdsum, floatreal *rdscal, integer *
	info);
...
/* Subroutine */ int ztgsyl_(char *trans, integer *ijob, integer *m, integer *
	...
	floatcomplex *c__, integer *ldc, floatcomplex *d__, integer *ldd, 
	floatcomplex *e, integer *lde, floatcomplex *f, integer *ldf, 
	floatreal *scale, floatreal *dif, floatcomplex *work, integer *
	lwork, integer *iwork, integer *info);

/* Subroutine */ int ztpcon_(char *norm, char *uplo, char *diag, integer *n, 
	floatcomplex *ap, floatreal *rcond, floatcomplex *work, floatreal 
	*rwork, integer *info);

/* Subroutine */ int ztprfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, floatcomplex *ap, floatcomplex *b, integer *ldb, 
	floatcomplex *x, integer *ldx, floatreal *ferr, floatreal *berr, 
	floatcomplex *work, floatreal *rwork, integer *info);
...
/* Subroutine */ int ztpttf_(char *transr, char *uplo, integer *n, 
	floatcomplex *ap, floatcomplex *arf, integer *info);

/* Subroutine */ int ztpttr_(char *uplo, integer *n, floatcomplex *ap, 
	floatcomplex *a, integer *lda, integer *info);

/* Subroutine */ int ztrcon_(char *norm, char *uplo, char *diag, integer *n, 
	floatcomplex *a, integer *lda, floatreal *rcond, floatcomplex *
	work, floatreal *rwork, integer *info);

/* Subroutine */ int ztrevc_(char *side, char *howmny, logical *select, 
	integer *n, floatcomplex *t, integer *ldt, floatcomplex *vl, 
	integer *ldvl, floatcomplex *vr, integer *ldvr, integer *mm, integer 
	*m, floatcomplex *work, floatreal *rwork, integer *info);

/* Subroutine */ int ztrexc_(char *compq, integer *n, floatcomplex *t, 
	integer *ldt, floatcomplex *q, integer *ldq, integer *ifst, integer *
	ilst, integer *info);

/* Subroutine */ int ztrrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, floatcomplex *a, integer *lda, floatcomplex *b, 
	integer *ldb, floatcomplex *x, integer *ldx, floatreal *ferr, 
	floatreal *berr, floatcomplex *work, floatreal *rwork, integer *
	info);

/* Subroutine */ int ztrsen_(char *job, char *compq, logical *select, integer 
	*n, floatcomplex *t, integer *ldt, floatcomplex *q, integer *ldq, 
	floatcomplex *w, integer *m, floatreal *s, floatreal *sep, 
	floatcomplex *work, integer *lwork, integer *info);

/* Subroutine */ int ztrsna_(char *job, char *howmny, logical *select, 
	integer *n, floatcomplex *t, integer *ldt, floatcomplex *vl, 
	integer *ldvl, floatcomplex *vr, integer *ldvr, floatreal *s, 
	floatreal *sep, integer *mm, integer *m, floatcomplex *work, 
	integer *ldwork, floatreal *rwork, integer *info);

/* Subroutine */ int ztrsyl_(char *trana, char *tranb, integer *isgn, integer 
	*m, integer *n, floatcomplex *a, integer *lda, floatcomplex *b, 
	integer *ldb, floatcomplex *c__, integer *ldc, floatreal *scale, 
	integer *info);
...
/* Subroutine */ int ztrttf_(char *transr, char *uplo, integer *n, 
	floatcomplex *a, integer *lda, floatcomplex *arf, integer *info);

/* Subroutine */ int ztrttp_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *ap, integer *info);

/* Subroutine */ int ztzrqf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, integer *info);

/* Subroutine */ int ztzrzf_(integer *m, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *lwork, 
	 integer *info);
...
/* Subroutine */ int zungtr_(char *uplo, integer *n, floatcomplex *a, 
	integer *lda, floatcomplex *tau, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zunm2l_(char *side, char *trans, integer *m, integer *n, 
	integer *k, floatcomplex *a, integer *lda, floatcomplex *tau, 
...
/* Subroutine */ int zunmbr_(char *vect, char *side, char *trans, integer *m, 
	integer *n, integer *k, floatcomplex *a, integer *lda, floatcomplex 
	*tau, floatcomplex *c__, integer *ldc, floatcomplex *work, integer *
	lwork, integer *info);

/* Subroutine */ int zunmhr_(char *side, char *trans, integer *m, integer *n, 
	integer *ilo, integer *ihi, floatcomplex *a, integer *lda, 
	floatcomplex *tau, floatcomplex *c__, integer *ldc, floatcomplex *
	work, integer *lwork, integer *info);
...
/* Subroutine */ int zunmlq_(char *side, char *trans, integer *m, integer *n, 
	integer *k, floatcomplex *a, integer *lda, floatcomplex *tau, 
	floatcomplex *c__, integer *ldc, floatcomplex *work, integer *lwork, 
	 integer *info);
...
/* Subroutine */ int zunmr3_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, floatcomplex *a, integer *lda, floatcomplex 
	*tau, floatcomplex *c__, integer *ldc, floatcomplex *work, integer *
	info);
...
/* Subroutine */ int zunmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, floatcomplex *a, integer *lda, floatcomplex *tau, 
	floatcomplex *c__, integer *ldc, floatcomplex *work, integer *lwork, 
	 integer *info);

/* Subroutine */ int zupgtr_(char *uplo, integer *n, floatcomplex *ap, 
	floatcomplex *tau, floatcomplex *q, integer *ldq, floatcomplex *
	work, integer *info);

/* Subroutine */ int zupmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, floatcomplex *ap, floatcomplex *tau, floatcomplex *c__, 
